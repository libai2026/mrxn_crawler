...
文章标题：[金和OA ApproveRemindSetExec.aspx XXE漏洞](https://mrxn.net/jswz/jhsoft-ApproveRemindSetExec-xxe.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-ApproveRemindSetExec-xxe.html>  
