...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office list.wsdl.php 接口处存在
...
![泛微e-office list.wsdl.php sql注入漏洞](https://image.mrxn.net/c2e5296623fd4123a1feef0c4617a5d6.webp)

webservice-json/workflow/list.wsdl.php 的
`GetMyCreatFlow`
业务逻辑如下
...
![泛微e-office list.wsdl.php sql注入漏洞](https://image.mrxn.net/6bf5c6a72b7e485389b68bcfc6c452d6.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-list-wsdl-sqli.html>
