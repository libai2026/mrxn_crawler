...
![天锐绿盾审批系统 addUpFile.do 任意文件上传漏洞](https://image.mrxn.net/335243b085b94222ba5cfeed12758c21.webp)
...
![天锐绿盾审批系统 addUpFile.do 任意文件上传漏洞](https://image.mrxn.net/d0f802cf33ea469585a064830d6b453a.webp)

全程对上传文件以及
`relativepath`
没有任何有效校验或者处理，直接保存，响应
`{"success":true}`
，代表上传成功，因此造成任意
[文件上传](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0)
漏洞。
...
![天锐绿盾审批系统 addUpFile.do 任意文件上传漏洞](https://image.mrxn.net/d4f51d46e5624054b4d1ba76fdaedf91.webp)
...
文章标题：
[天锐绿盾审批系统 addUpFile.do 任意文件上传漏洞](https://mrxn.net/jswz/trwfe-addUpFile-upload-rce.html)
  
文章链接：
<https://mrxn.net/jswz/trwfe-addUpFile-upload-rce.html>
