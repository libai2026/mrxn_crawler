...
![西部数码 NAS  login_mgr.cgi 命令执行漏洞](https://image.mrxn.net/d1ea9c8b12a74437853c16c73360e619.webp)
...
![西部数码 NAS  login_mgr.cgi 命令执行漏洞](https://image.mrxn.net/acd0c501c8634107ad6547dc6e6a9edb.webp)
...
`sprintf`
函数直接格式化到
`net ads search -P '(... sAMAccountName=%s ...)'`
命令字符串中。

![西部数码 NAS  login_mgr.cgi 命令执行漏洞](https://image.mrxn.net/2ca3b0a508894089ae8bfe38535e5be3.webp)

![西部数码 NAS  login_mgr.cgi 命令执行漏洞](https://image.mrxn.net/0428df5a12014be4b32176cb9c177e0a.webp)
...
`popen`
会创建一个新的 shell 进程来
[执行该命令](https://mrxn.net/tag/rce)
。

# 漏洞复现

![西部数码 NAS  login_mgr.cgi 命令执行漏洞](https://image.mrxn.net/aa50b1a7f8914d23a919c88425d1420f.webp)
...
![西部数码 NAS  login_mgr.cgi 命令执行漏洞](https://image.mrxn.net/ee20ac11d54d435ca21dd3a547843568.webp)
...
文章标题：
[西部数码 NAS login\_mgr.cgi 命令执行漏洞](https://mrxn.net/jswz/west-nas-login_mgr-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-login_mgr-rce.html>
