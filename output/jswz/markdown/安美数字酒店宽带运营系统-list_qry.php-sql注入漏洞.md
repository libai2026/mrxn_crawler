...
文章标题：[安美数字酒店宽带运营系统 list\_qry.php SQL注入漏洞](https://mrxn.net/jswz/amttgroup-user-list_qry-UserID-sqli.html)  
文章链接：<https://mrxn.net/jswz/amttgroup-user-list_qry-UserID-sqli.html>  
