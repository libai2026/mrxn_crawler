...
和
`web_time`
参数）未经充分过滤或转义，直接拼接到操作系统命令中并通过
`shell_exec`
函数执行，导致
[命令执行漏洞](https://mrxn.net/tag/rce)
。
...
访问命令执行结果文件
`/cgi/fsystem/test.txt`

![Optilink 管理系统 gene.php 命令执行漏洞](https://image.mrxn.net/45d4cf877cc543e2b01cbc1489ba3839.webp)
...
文章链接：
<https://mrxn.net/jswz/optilink-cgi-fsystem-gene-2rce.html>
...
text: encodeURI("https://mrxn.net/jswz/optilink-cgi-fsystem-gene-2rce.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
