...
文章标题：[普华Powerpms OfficeService.aspx 金格组件payload分析+SQL注入漏洞](https://mrxn.net/jswz/powerplat-FormXml-DocFile-OfficeService-sqli.html)  
文章链接：<https://mrxn.net/jswz/powerplat-FormXml-DocFile-OfficeService-sqli.html>  
