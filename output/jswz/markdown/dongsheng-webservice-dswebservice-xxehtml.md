...
东胜物流软件是青岛东胜伟业软件有限公司一款集订单管理、仓库管理、运输管理等多种功能于一体的物流管理软件。东胜物流软件 DsWebService.asmx 接口UpdateCustomMainfast方法存在 XML 外部实体注入（
...
![东胜物流软件 DsWebService.asmx XXE漏洞](https://image.mrxn.net/b3acef01d07f40ce85b48f912dc40fd5.webp)
...
文章标题：
[东胜物流软件 DsWebService.asmx XXE漏洞](https://mrxn.net/jswz/dongsheng-Webservice-DsWebService-XXE.html)
  
文章链接：
<https://mrxn.net/jswz/dongsheng-Webservice-DsWebService-XXE.html>
