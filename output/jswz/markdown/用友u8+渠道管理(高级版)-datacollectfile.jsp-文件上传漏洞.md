...
文章标题：[用友U8+渠道管理(高级版) datacollectfile.jsp 文件上传漏洞](https://mrxn.net/jswz/yonyou-business-common-view-datacollectfile-upload-rce.html)  
文章链接：<https://mrxn.net/jswz/yonyou-business-common-view-datacollectfile-upload-rce.html>  
