...
NC 是一种商业级的企业资源规划，为企业提供全面的管理解决方案，包括财务管理、采购管理、销售管理、人力资源管理等功能，基于云原生架构，深度应用新一代数字技术，打造开放、 互联、融合、智能的一体化云平台，支持公有云、混合云、专属云的灵活部署模式。聚焦数字化管理、数字化经营、数字化平台等三大企业数字化转型战略方向，提供涵盖数字营销、智能制造、财务共享、人力共享与协同，智慧采购、数字中台等18大解决方案，助力大型企业全面落地数字化和业务流程优化。用友NC isAgentLimit 接口处pk\_flowagent参数存在
...
![用友NC isAgentLimit SQL注入漏洞](https://image.mrxn.net/922964e92cdf46c481aeedfbfabad4cd.webp)
...
,两个参数均存在SQL注入漏洞，网上POC只提到了和官方通告一样的参数，而忽略了第二个参数。
...
![用友NC isAgentLimit SQL注入漏洞](https://image.mrxn.net/fec31da7f1bf4e58acd3ed2f1ba3a671.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-oacoSchedulerEvents-isAgentLimit-agent-sqli.html>
