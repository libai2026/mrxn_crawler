...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS google\_analytics.php中存在
...
和
`arg`
参数，在未进行任何过滤或转义的情况下，直接将其拼接到 $run\_cmd中，然后用
`system()`
函数执行的系统命令中，导致了
...
![西部数码 NAS google_analytics.php 命令执行漏洞](https://image.mrxn.net/fd549b518eaf4efb97b41d4ecf047d9b.webp)
...
文章标题：
[西部数码 NAS google\_analytics.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-google_analytics-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-google_analytics-rce.html>
