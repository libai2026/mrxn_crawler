...
上海孚盟软件有限公司是一家专业的外贸SaaS服务和行业解决方案提供商。其旗下产品孚盟云AjaxProductTemplateList.ashx接口存在
...
![孚盟云CRM AjaxProductTemplateList.ashx SQL注入漏洞](https://image.mrxn.net/3a096792e4f64e39953c274fbf4af5da.webp)

通过报错注入，成功在响应里回显数据库版本信息

**method=DeletePrdTemplate**
与
**method=GetPrdTemplate**
亦如此，就不在此赘述了。
...
文章标题：
[孚盟云CRM AjaxProductTemplateList.ashx SQL注入漏洞](https://mrxn.net/jswz/fumacrm-Dingding-AjaxProductTemplateList-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/fumacrm-Dingding-AjaxProductTemplateList-sqli.html>
