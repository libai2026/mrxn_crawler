...
![金和OA AjaxForCompanyCollect.ashx SQL注入漏洞](https://image.mrxn.net/98176366e0084cf6ac1289f574f6391e.webp)

当
`strType=getCollectList`
`strAppType=start`
时，
`strYear`
、
...
![金和OA AjaxForCompanyCollect.ashx SQL注入漏洞](https://image.mrxn.net/9ab52a7a397d49c1b182575c2c052318.webp)
...
文章标题：
[金和OA AjaxForCompanyCollect.ashx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AjaxForCompanyCollect-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AjaxForCompanyCollect-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-AjaxForCompanyCollect-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
