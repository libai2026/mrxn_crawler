...
文章标题：[天锐绿盾审批系统 downFileByconfirm.do 任意文件读取漏洞](https://mrxn.net/jswz/trwfe-downFileByconfirm-file-read.html)  
文章链接：<https://mrxn.net/jswz/trwfe-downFileByconfirm-file-read.html>  
