...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS modUserName.php中存在
...
漏洞。尽管需要管理员权限，但可以结合login\_check的权限绕过达到
...
![西部数码 NAS modUserName.php 命令执行漏洞](https://image.mrxn.net/63b83ed095974f7e8744143940a76b33.webp)
...
文章标题：
[西部数码 NAS modUserName.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-modUserName-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-modUserName-rce.html>
