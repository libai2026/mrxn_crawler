...
[![NginxRewrite规则判断普通用户与搜索引擎爬虫（UA）实现https跳转](https://mrxn.net/content/uploadfile/201509/187f1443105009.jpg "点击查看原图")](https://mrxn.net/content/uploadfile/201509/187f1443105009.jpg)

前段时间写了一篇关于给博客安装证书加密访问的文章，在站长平台，百度说支持https，一个月后发现网站的流量排名跌成了狗，为了逼格保留这个https，又为了不和百度做对，查阅相关资料后选择用user\_agent来解决，nginx本身就能判断UA，以下代码供大家参考，添加到nginxRewr
**it**
...
[![NginxRewrite规则判断普通用户与搜索引擎爬虫（UA）实现https跳转](https://mrxn.net/content/uploadfile/201509/36e51443105060.jpg "点击查看原图")](https://mrxn.net/content/uploadfile/201509/36e51443105060.jpg)
...
文章标题：
[NginxRewrite规则判断普通用户与搜索引擎爬虫（UA）实现https跳转](https://mrxn.net/jswz/nginx-ua-https.html)
  
文章链接：
<https://mrxn.net/jswz/nginx-ua-https.html>
...
text: encodeURI("https://mrxn.net/jswz/nginx-ua-https.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
