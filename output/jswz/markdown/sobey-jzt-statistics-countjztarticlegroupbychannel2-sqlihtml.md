...
索贝产品中的 /sobey-mchEditor/mch/Jzt/statistics/countJztArticleGroupByChannel2 接口存在
...
根据漏洞信息看下
`mch/Jzt/statistics/countJztArticleGroupByChannel2`
的实现逻辑
...
![索贝融媒体 /sobey-mchEditor/mch/Jzt/statistics/countJztArticleGroupByChannel2 SQL注入漏洞](https://image.mrxn.net/af9a1f2fe37e4c8aa2d15f998437a143.webp)

代码一看就很明了了，
**channelId**
和
**ID**
无任何过滤或校验，被直接拼接在in子语句中，从而造成了
...
![索贝融媒体 /sobey-mchEditor/mch/Jzt/statistics/countJztArticleGroupByChannel2 SQL注入漏洞](https://image.mrxn.net/5e02fa3ac6f24f31ba827d2d464165e8.webp)
...
文章标题：
[索贝融媒体 /sobey-mchEditor/mch/Jzt/statistics/countJztArticleGroupByChannel2 SQL注入漏洞](https://mrxn.net/jswz/sobey-Jzt-statistics-countJztArticleGroupByChannel2-sqli.html)
