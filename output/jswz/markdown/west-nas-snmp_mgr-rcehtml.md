...
漏洞。该脚本在处理SNMP管理相关请求时，可能由于未对用户输入进行充分的过滤和验证，直接将用户提供的参数传递给系统命令执行函数或拼接进命令执行语句里。攻击者可以通过构造恶意的请求参数，注入操作系统命令，从而在服务器上
[执行任意命令](https://mrxn.net/tag/rce)
。
...
![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/ef5ff561a98741f39c83bfeaa66e45f3.webp)
...
![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/882b18183247443280be12bad18785ae.webp)
...
![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/968663084d8a4f5ebcec8ac7aee58dc2.webp)
...
![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/94d66e38d9e74629832c0f48531e5fcf.webp)
...
![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/1be9b131f505401b8829952bc3eb5819.webp)

访问生成的文件，成功创建

## cgi\_set\_SNMP\_v2

![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/e0471665c71a4657b1b2712a94497532.webp)

![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/ff40b02966224e9283a236f17d69d70e.webp)

成功执行命令

## cgi\_SNMPv3\_modify\_one\_record

![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/02b70da65e9c4abb9a000497703fa8e7.webp)

![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/fd61103b4aa844dca666a0a2d39c4086.webp)

## cgi\_set\_SNMPv3\_one\_record

![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/69c27c781ba34ee28a542ee7e802d5bc.webp)

![西部数码 NAS  snmp_mgr.cgi 多处命令执行漏洞](https://image.mrxn.net/113636b503974738980cf7d1f03f91fb.webp)
...
文章标题：
[西部数码 NAS snmp\_mgr.cgi 多处命令执行漏洞](https://mrxn.net/jswz/west-nas-snmp_mgr-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-snmp_mgr-rce.html>
