...
东胜物流系统是一款用于物流管理的系统。该系统的 /SoftMng/FileInputHandler/Upload 接口存在未授权的
[文件上传](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0)
漏洞。攻击者可以通过该接口上传恶意文件（如webshell），从而获取服务器权限，导致系统安全受到严重威胁。
...
在DSWeb.SoftMng.Controllers下找到
**FileInputHandlerController**
里的
**Upload()**
方法
...
2. **回显的上传路径**
   ：上传路径为
   `../../UploadFiles/Filepuload/yyyyMM/`
   ，且会通过json返回文件路径
   `arrayList.Add((object) (str1 + str3));`
3. **Web 可访问目录**
   ：文件保存在
   `UploadFiles`
   下，该目录通常可被 Web 服务器直接访问
...
![东胜物流软件 /SoftMng/FileInputHandler/Upload 文件上传漏洞](https://image.mrxn.net/a96511bfcdd2445ab1c36ec4d79d9787.webp)
...
文章链接：
<https://mrxn.net/jswz/dongsheng-SoftMng-FileInputHandler-Upload-RCE.html>
