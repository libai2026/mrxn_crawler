...
getFileAction 接收一个 fileName 参数，将其直接拼接到
`file_get_contents`
函数的
`$filename`

部分读取，无任何过滤或校验，因此造成任意
...
![锐捷-EWEB timeout.php 文件读取漏洞](https://image.mrxn.net/e2433a412d6049e3b49ff42339f02422.webp)
...
![锐捷-EWEB timeout.php 文件读取漏洞](https://image.mrxn.net/cc8783a4e29d4810997da79d401c62ef.webp)
...
文章链接：
<https://mrxn.net/jswz/ruijieweb-system_pi-timeout-fileread.html>
