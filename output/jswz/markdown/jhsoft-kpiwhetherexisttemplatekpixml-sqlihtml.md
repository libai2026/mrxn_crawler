...
`KpiWhetherExistTemplateKpiXml.aspx`
接口处存在
...
`bin`
目录下查找
`JHBase.Web.Appraise.dll`
将其进行反编译后找到
**KpiWhetherExistTemplateKpiXml**
的处理逻辑
...
![金和OA KpiWhetherExistTemplateKpiXml.aspx SQL注入漏洞](https://image.mrxn.net/85f43a75541e481da2a3dcaab13923b1.webp)
...
文章标题：
[金和OA KpiWhetherExistTemplateKpiXml.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-KpiWhetherExistTemplateKpiXml-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-KpiWhetherExistTemplateKpiXml-sqli.html>
