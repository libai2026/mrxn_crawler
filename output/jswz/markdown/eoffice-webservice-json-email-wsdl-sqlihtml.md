...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office email.wsdl.php 接口处存在
...
![泛微e-office email.wsdl.php sql注入漏洞](https://image.mrxn.net/408ed73fef9d4e169fc87f40dba77cc3.webp)

webservice-json/email/email.wsdl.php 的
`GetEmailSingle`
业务逻辑如下
...
![泛微e-office email.wsdl.php sql注入漏洞](https://image.mrxn.net/33231a961de54d7ea6b4fc27585418a9.webp)
...
![泛微e-office email.wsdl.php sql注入漏洞](https://image.mrxn.net/469f7630e0b54b7da8a49d5611ad65c7.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-email-wsdl-sqli.html>
