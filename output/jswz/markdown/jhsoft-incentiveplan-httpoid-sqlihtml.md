...
金和网络是专业信息化服务商,为城市监管部门提供了互联网+监管解决方案,为企事业单位提供组织协同OA系统开发平台,电子政务一体化平台,智慧电商平台等服务。金和OA C6 IncentivePlanFulfillAppprove.aspx接口处存在
...
* 调用
  ...
  和
  `GetIncentivePlanMessageById`
  方法，获取计划的当前版本和完整的计划详情。
* 如果计划的标题（
  `IncentiveTitle`
  ）为空，则直接输出错误信息
  `"页面数据错误。。。"`
...
先将 TPlanID 代入
`new JHSoft.IncentivePlan.BLL.IncentivePlan().GetCurrentPlanVersion`
获取版本号 TVersion，然后再将其和 TPlanID 一起代入
`new JHSoft.IncentivePlan.BLL.GetIncentivePlanMessageById`
函数中。
...
![金和OA C6 IncentivePlanFulfillAppprove.aspx SQL注入漏洞](https://image.mrxn.net/064b31f3b20b4fcbab97d764af79faf4.webp)
...
文章链接：
<https://mrxn.net/jswz/jhsoft-IncentivePlan-httpOID-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-IncentivePlan-httpOID-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
