...
文章标题：[天锐绿盾审批系统 /conf/editConfigVal fastjson反序列化漏洞](https://mrxn.net/jswz/trwfe-editConfigVal-fastjson-rce.html)  
文章链接：<https://mrxn.net/jswz/trwfe-editConfigVal-fastjson-rce.html>  
