...
* [![OpenWrt passwall 定时自动切换节点](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/how-to-auto-change-openwrt-passwall-default-nodes-with-crontab.html)
...
* [![nmap 错误 Couldn't open a raw socket. Error: Permission denied (13)](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/710.html)
...
* [![使用Linux命令查找占用磁盘空间最大的20个文件](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/708.html)
...
* [![删除history中指定某条记录](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/703.html)
...
* [![一行命令Linux 统计长连接的外部 IP 地址](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/691.html)
...
* [![一行命令快速筛选出高可靠的代理](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/690.html)
...
* [![linux 一行命令获取开机时间](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/688.html)
...
* [![update-golang：一个帮助你快速安装或者更新到最新版 golang 的 Linux 脚本](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/595.html)
...
* [![Debian10 x64 build make install Haproxy v2.2.0-在Debian10 64位系统编译安装最新版 Haproxy v2.2.0版本](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/668.html)
...
* [![宝塔(bt.cn)面板开启域名登录并且使用域名证书,解决浏览器信任证书问题](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/Onekey-Open-BT-panel-ssl-with-domain.html)
...
* [![一键搭建kms激活服务端&&Windows客户端一键激活脚本](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/kms-server-deploy.html)
...
* [![windows10安装kali子系统&&https: aptMethod::Configuration: could not load seccomp policy: Invalid argument解决办法](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/windows10-install-wsl-kali.html)
...
* [![linux 文件权限字符表示&数字表示](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/online-linux-chmod-permissions.html)
...
* [![系统中X1-lock进程Xorg占用CPU爆表通过shell脚本解决以及shell一些知识【笔记】](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/kill-x1-lock-xorg-with-shell.html)
...
* [![Kali一键安装docker脚本](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/install_docker_script_for_Kali.html)
...
* [![linux下解压rar格式的文件](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/linux-rar.html)
...
* [![Linux 下十大命令行下载工具(转)](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/top-10-command-line-tools-downloading-linux.html)
...
* [![linux使用问题处理小计(勿入)](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/578.html)
...
* [![为nginx添加这些额外的第三方扩展加速你的web吧](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/nginx_add_module.html)
...
* [![两种方式反代Google(镜像)--nginx反代和nginx扩展](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/nginx_http_google_filter.html)
...
* [![利用grep,cut,awk处理一些文本的简记](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/549.html)
...
* [![centos开启ssh密钥登录总结](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/547.html)
...
* [![LInux远程文件传输效率工具-lrzsz](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/542.html)
...
* [![error while loading shared libraries: libsodium.so.18: cannot open shared](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/541.html)
...
* [![Linux Find 命令精通指南(转)](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/539.html)
...
* [![搭建 nginx + mysql + php-fpm 环境（CentOS 6）](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/536.html)
...
* [![在UEFI+GPT下使用rEFind实现Win10 + Kali2.0 双引导](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/UEFI-GPT-rEFind-Win10-Kali20.html)
...
* [![Kali渗透测试演练Metasploitable靶机(附详细word文档+乌云_vmware_201606)](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/Use-Kali-Metasploitable-do-sth-test.html)
...
* [![利用 iptables 折腾安全的服务器环境](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/iptables-use-note.html)
...
* [![linux执行shell脚本的方式及一些区别](https://mrxn.net/content/templates/AIO/assets/images/loading.gif)](https://mrxn.net/Linux/different-linux-shell-do.html)
...
1
[2](https://mrxn.net/jswz/Linux/page/2)
