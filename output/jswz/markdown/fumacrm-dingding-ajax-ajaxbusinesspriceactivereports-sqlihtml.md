...
上海孚盟软件有限公司是一家专业的外贸SaaS服务和行业解决方案提供商。其旗下产品孚盟云AjaxBusinessPriceActiveReports.ashx接口存在
...
直接看
`AjaxBusinessPriceActiveReports.ashx`
对应的dll文件
`FumaCRM_BS.NewWeb.dll`
里有关
**AjaxBusinessPriceActiveReports**
方法的实现如下
...
当Cookie里的UserCookie的
**custNo值不为空时**
，
**custNo**
未经过任何过滤或校验就被直接拼接进SQL语句中进行执行，从而造成SQL注入漏洞，这里需要注意数据库相关操作为MySQL数据库，而非sql server ！
...
![孚盟云CRM AjaxBusinessPriceActiveReports.ashx SQL注入漏洞](https://image.mrxn.net/43aa4ada8ed94ec98364bef60c161a44.webp)
...
文章标题：
[孚盟云CRM AjaxBusinessPriceActiveReports.ashx SQL注入漏洞](https://mrxn.net/jswz/fumacrm-Dingding-Ajax-AjaxBusinessPriceActiveReports-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/fumacrm-Dingding-Ajax-AjaxBusinessPriceActiveReports-sqli.html>
