...
变量，然后拼接成
`$url = $root . $name`
，其中 $root 为固定值 "/tmp/html/"。未对
`$name`
进行任何过滤或验证，因此攻击者可以通过在
`$name`
中注入目录遍历序列（如 "../"）来访问系统中的任意文件，绕过预设的根目录限制，因此造成任意
...
![锐捷-EWEB check.php 文件读取漏洞](https://image.mrxn.net/e2433a412d6049e3b49ff42339f02422.webp)
...
![锐捷-EWEB check.php 文件读取漏洞](https://image.mrxn.net/2992ce1ab7374f7dae6d2d3c5103fa38.webp)
...
文章链接：
<https://mrxn.net/jswz/ruijieweb-check-fileread.html>
