...
`bin`
目录下查找
`JHBase.Web.dossier.dll`
将其进行反编译后找到
**DelSelectSummaryIndicators**
的处理逻辑
...
![金和OA DelSelectSummaryIndicators.aspx SQL注入漏洞](https://image.mrxn.net/99857d360c7c43fbb19462e5949a5fc3.webp)
...
文章标题：
[金和OA DelSelectSummaryIndicators.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-DelSelectSummaryIndicators-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-DelSelectSummaryIndicators-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-DelSelectSummaryIndicators-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
