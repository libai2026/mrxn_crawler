...
MetaCRM是一款智能平台化CRM软件,通过提升企业管理和协同办公,全面提高企业管理水平和运营效率,帮助企业实现卓越管理。美特CRM headimgsave 接口存在
...
从它的实现可以很清楚的看到参数id被直接拼接进SQL语句中后执行,没有对参数有任何过滤或校验,从而导致
[SQL注入漏洞](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
.

同时此处或许还存在任意内容上传,通过上面的注入让其结果返回false进入
`saveHeadImg`
,可上传任意内容,如果jdk版本低于1.7 还可以通过%00截断保存任意后缀文件.

![美特CRM headimgsave SQL注入漏洞](https://image.mrxn.net/d2d0341da1124b758bf23918da845180.webp)
...
![美特CRM headimgsave SQL注入漏洞](https://image.mrxn.net/49f3246fadab43c8bd2c051320f77222.webp)
...
文章链接：
<https://mrxn.net/jswz/metasoft-headimgsave-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/metasoft-headimgsave-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
