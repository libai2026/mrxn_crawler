...
文章标题：[金和OA CompanyBudgetCollect.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-CompanyBudgetCollect-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-CompanyBudgetCollect-sqli.html>  
