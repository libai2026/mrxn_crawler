---
title: "Gravatar被墙后解决头像不能正常显示的五种方法（持续更新中。。。）"
source: https://mrxn.net/jswz/63.html
---

# Gravatar被墙后解决头像不能正常显示的五种方法（持续更新中。。。）

[Mrxn](https://mrxn.net/author/1)* 发表于2014/11/30 06:52
* 12513浏览
* [2评论](#comment)
* 22分钟
  阅读
...
Gravatar被墙后，很多博客的头像显示都不正常了，网上也有很多的方法，但是不全面，今天
[Mrxn](https://mrxn.net)
帮你搜集汇总，发布在
...
**修改为：
**http://cn.gravatar.com/site/implement/images/****
...
使用方法：在module.php的最新评论 显示评论 显示子评论里面将getGravatar替换成get\_avatar 。
...
[让emlog的留言板和评论使用本地头像，加速访问，提升美观](https://mrxn.net/jswz/84.html)

**更多方法正在搜集研究中，尽请期待！请关注我的博客：https://mrxn.net**

**如果你有好的方法或者是文章，欢迎投稿或者是注册：
[注册](https://mrxn.net/?plugin=yls_reg)




[匿名投稿](https://mrxn.net/?plugin=qiukong_submit)**
...
文章标题：
[Gravatar被墙后解决头像不能正常显示的五种方法（持续更新中。。。）](https://mrxn.net/jswz/63.html)
  
文章链接：
<https://mrxn.net/jswz/63.html>
...
text: encodeURI("https://mrxn.net/jswz/63.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
