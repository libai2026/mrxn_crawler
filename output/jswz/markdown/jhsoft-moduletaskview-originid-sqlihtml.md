...
根据 ModuleTaskView.aspx 的实现，在 bin 目录下查找
...
参数 strOriginModule、strOriginID 被直接拼接进SQL语句中后执行，无任何过滤或校验，导致
[SQL注入漏洞](https://mrxn.net/tag/sql%E6%B3%A8%E5%85%A5)
。
...
![金和OA ModuleTaskView.aspx SQL注入漏洞](https://image.mrxn.net/9ecd47a12dca4ea8a0600a2157804d5f.webp)
...
文章链接：
<https://mrxn.net/jswz/jhsoft-ModuleTaskView-OriginID-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-ModuleTaskView-OriginID-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
