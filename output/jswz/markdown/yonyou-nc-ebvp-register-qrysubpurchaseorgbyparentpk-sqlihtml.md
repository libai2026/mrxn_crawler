...
`RegCommonController`
对应的
`doQuerySubPurchaseOrgByParentPk`
方法实现部分
...
![用友NC qrySubPurchaseOrgByParentPk SQL注入漏洞](https://image.mrxn.net/519dfcacc3ce40d7960ec19110f97b71.webp)
...
![用友NC qrySubPurchaseOrgByParentPk SQL注入漏洞](https://image.mrxn.net/76192865ea6b4371845183a61ee78145.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-ebvp-register-qrySubPurchaseOrgByParentPk-sqli.html>
