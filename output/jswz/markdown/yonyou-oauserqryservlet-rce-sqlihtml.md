...
![用友NC OAUserQryServlet 反序列化漏洞+SQL注入漏洞](https://image.mrxn.net/9f4fd82858d74bb49e1dc0bdab7ecf70.webp)

成功执行命令并回显执行结果

![用友NC OAUserQryServlet 反序列化漏洞+SQL注入漏洞](https://image.mrxn.net/eda40aad71374460b064acdb6dfa41b5.webp)
...
文章标题：
[用友NC OAUserQryServlet 反序列化漏洞+SQL注入漏洞](https://mrxn.net/jswz/yonyou-OAUserQryServlet-rce-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/yonyou-OAUserQryServlet-rce-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/yonyou-OAUserQryServlet-rce-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
