...
NetMizer日志管理系统是一款用于网络流量管理和优化的日志记录与分析工具，能够高效采集、存储和分析网络设备及应用生成的日志数据。然而，该系统中的
`dirlist.php`
接口未对用户输入进行充分验证，存在
[目录遍历](https://mrxn.net/tag/%E7%9B%AE%E5%BD%95%E9%81%8D%E5%8E%86)
漏洞（Directory Traversal）。攻击者可以通过构造恶意请求，利用该漏洞访问系统中未经授权的文件或目录，从而可能导致敏感信息泄露。
...
![NetMizer日志管理系统 dirlist.php 目录遍历漏洞（CNVD-2017-37549）](https://image.mrxn.net/d24560183abc4a19b13564651e9b7f58.webp)
...
文章链接：
<https://mrxn.net/jswz/netmizer-data-manage-dirlist-node-directory-traversal.html>
...
text: encodeURI("https://mrxn.net/jswz/netmizer-data-manage-dirlist-node-directory-traversal.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
