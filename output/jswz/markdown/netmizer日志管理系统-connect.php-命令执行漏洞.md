...
文章标题：[NetMizer日志管理系统 connect.php 命令执行漏洞](https://mrxn.net/jswz/netmizer-manage-connect-start-ifname-rce.html)  
文章链接：<https://mrxn.net/jswz/netmizer-manage-connect-start-ifname-rce.html>  
