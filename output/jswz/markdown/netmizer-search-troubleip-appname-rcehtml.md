...
`$appname`
也是直接拼接进命令执行字符串中用 exec 来执行最终的命令，造成
[命令注入](https://mrxn.net/tag/rce)
漏洞。
...
![NetMizer日志管理系统 troubleip.php 命令执行漏洞](https://image.mrxn.net/a35a7ea221fc446e8677fa35b55ad8d0.webp)
...
文章链接：
<https://mrxn.net/jswz/netmizer-search-troubleip-appname-rce.html>
