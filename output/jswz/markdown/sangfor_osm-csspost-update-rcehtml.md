...
深信服运维安全管理系统 csspost/update 接口存在远程
...
看下
`com.sbr.fort.foreignSXF.newSXF.CsspController#update`
的实现逻辑

![深信服运维安全管理系统 csspost/update 远程命令执行漏洞](https://image.mrxn.net/f5fc7742685d4586ae6d57d91a3d5386.webp)
...
* 由于没有对
  ...
  ``` `` 或 ```
  ||`）来
  [执行任意系统命令](https://mrxn.net/tag/rce)
  。
...
![深信服运维安全管理系统 csspost/update 远程命令执行漏洞](https://image.mrxn.net/0b027343572a407fadd72c1d5a1495ff.webp)

**/csspost/OSM/update**
亦如此

![深信服运维安全管理系统 csspost/update 远程命令执行漏洞](https://image.mrxn.net/8fba6bf22f1349418393517566b7abd6.webp)

![深信服运维安全管理系统 csspost/update 远程命令执行漏洞](https://image.mrxn.net/bb2663a3f40e40d884c1d5e36d0171a0.webp)
...
![深信服运维安全管理系统 csspost/update 远程命令执行漏洞](https://image.mrxn.net/4c6f5f6e3a4f4370a520ceda847556a4.webp)
...
![深信服运维安全管理系统 csspost/update 远程命令执行漏洞](https://image.mrxn.net/ded9db53709b4d7fab92ec0cc007cf67.webp)
...
文章链接：
<https://mrxn.net/jswz/sangfor_osm-csspost-update-rce.html>
