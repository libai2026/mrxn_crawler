...
ps
：也要查看邮箱中“设置邮件地址黑名单”及“收信规则”，有时系统会自动将一些邮箱自动加入黑名单的
...
文章标题：
[phpmailer发送邮件 SMTP Error: Could not authenticate 错误](https://mrxn.net/jswz/phpmailer.html)
  
文章链接：
<https://mrxn.net/jswz/phpmailer.html>
