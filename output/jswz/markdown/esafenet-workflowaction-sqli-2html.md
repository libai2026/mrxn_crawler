...
亿赛通电子文档安全管理系统的WorkFlowAction接口存在
[SQL注入漏洞](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
。攻击者可以通过构造特定的POST请求，在flowId参数中注入恶意SQL代码，利用该漏洞对数据库执行任意SQL操作。攻击者可以通过注入WAITFOR DELAY命令，导致数据库响应时间延迟，从而确认
...
可知，访问路由为 /3g/WorkFlowAction ，具体实现逻辑类为
`com.esafenet.mobile.WorkFlowAction`
，跟进查看
`Approval`
实现方式
...
![亿赛通电子文档安全管理系统 WorkFlowAction SQL注入漏洞](https://image.mrxn.net/124aae559a9e4373ac4ec0c9dd2340b9.webp)
...
文章链接：
<https://mrxn.net/jswz/esafenet-WorkFlowAction-sqli-2.html>
