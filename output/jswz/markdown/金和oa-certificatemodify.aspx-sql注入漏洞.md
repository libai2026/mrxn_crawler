...
文章标题：[金和OA CertificateModify.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-CertificateModify-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-CertificateModify-sqli.html>  
