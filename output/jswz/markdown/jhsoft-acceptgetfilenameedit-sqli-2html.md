...
根据 AcceptGetFileNameEdit.aspx 的源码，在 bin 目录下查找 JHBase.Web.AcceptAip.dll 将其进行反编译后找到
`AcceptGetFileNameEdit`
的处理逻辑
...
![金和OA AcceptGetFileNameEdit.aspx SQL注入漏洞](https://image.mrxn.net/c1b07205e4344732b3ee0ffb8f42f80f.webp)
...
文章标题：
[金和OA AcceptGetFileNameEdit.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AcceptGetFileNameEdit-sqli-2.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AcceptGetFileNameEdit-sqli-2.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-AcceptGetFileNameEdit-sqli-2.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
