...
上海孚盟软件有限公司是一家专业的外贸SaaS服务和行业解决方案提供商。其旗下产品孚盟云`LicManage.ashx`接口存在[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)漏洞，未经身份验证的远程攻击者除了可以利用SQL注入漏洞获取数据库中的信息(例如，管理员后台密码、站点的用户个人信息)之外，甚至在高权限的情况可向服务器中写入木马，进一步获取服务器系统权限。
...
文章标题：[孚盟云CRM LicManage.ashx SQL注入漏洞](https://mrxn.net/jswz/fumacrm-LicManage-sqli.html)  
文章链接：<https://mrxn.net/jswz/fumacrm-LicManage-sqli.html>  
