...
红帆iOffice的/ioffice/prg/Mobile/Base/MobileBind.aspx接口存在
...
![红帆ioffice MobileBind.aspx SQL 注入漏洞](https://image.mrxn.net/f8dee53ed1274dc68c09aae5b84aba08.webp)
...
**txtUDIDReqHisID**
被带入
`Mobile.Mobile.GetclientUDIDReqHisByID`
方法，跟进看下
...
ok,到这里，漏洞成因就非常明了了，从前端TextBox获取的
**txtUDIDReqHisID**
最终经过一系列赋值传递后被直接拼接进
`$"select * from clientUDIDReqHis where ID in ({ID})"`
...
![红帆ioffice MobileBind.aspx SQL 注入漏洞](https://image.mrxn.net/111c291fbc9b41e4bc7c78f2ccd8428d.webp)
...
文章标题：
[红帆ioffice MobileBind.aspx SQL 注入漏洞](https://mrxn.net/jswz/ioffice-MobileBind-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/ioffice-MobileBind-sqli.html>
