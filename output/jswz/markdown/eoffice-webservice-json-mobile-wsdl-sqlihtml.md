...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office mobile.wsdl.php 接口处存在
...
webservice-json/mobile/mobile.wsdl.php 的
`Send`
业务逻辑如下
...
`$fromNumber, $toNumber, $content, $fromID, $toID`
带入
`Send`
函数
...
![泛微e-office mobile.wsdl.php sql注入漏洞](https://image.mrxn.net/497b035cbb66402ea835343324640b5b.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-mobile-wsdl-sqli.html>
