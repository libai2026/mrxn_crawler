...
`AjaxForCenterBudgetDecompose.ashx`
接口处存在SQL注入漏洞，攻击者除了可以利用
...
整体执行流程如下，当中其他几个方法也存在同样的
[sql注入](https://mrxn.net/tag/sql%E6%B3%A8%E5%85%A5)
漏洞，就不赘述了

![金和OA AjaxForCenterBudgetDecompose.ashx SQL注入漏洞](https://image.mrxn.net/e895bcc069c84779acf816225988a8b0.webp)
...
![金和OA AjaxForCenterBudgetDecompose.ashx SQL注入漏洞](https://image.mrxn.net/ea8a5fa734c74bada80ec0476dd770d1.webp)
...
文章标题：
[金和OA AjaxForCenterBudgetDecompose.ashx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AjaxForCenterBudgetDecompose-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AjaxForCenterBudgetDecompose-sqli.html>
