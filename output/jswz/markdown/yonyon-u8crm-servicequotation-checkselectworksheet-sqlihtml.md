...
用友U8 CRM客户关系管理系统是一款专业的企业级CRM软件，旨在帮助企业高效管理客户关系、提升销售业绩和提供优质的客户服务。用友 U8 CRM客户关系管理系统
`checkselectworksheet.php`
文件存在
...
那直接看
`U8SOFT/turbocrm70/code/www/servicequotation/checkselectworksheet.php`
业务逻辑实现关键部分
...
`$wsIDs = TGetRequest('wsIDs')`
获取外部输入参数并在 $checkSql 字符串中无任何过滤，无任何过滤和校验，造成
...
![用友U8 CRM checkselectworksheet.php SQL注入漏洞](https://image.mrxn.net/87f2994731c84d078b3195445aea28ed.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyon-u8crm-servicequotation-checkselectworksheet-sqli.html>
