...
文章标题：[友加畅捷管理系统U+标准版 picOnload 任意文件上传漏洞（鉴权后）](https://mrxn.net/jswz/youjiasoft-Other-picOnload-upload-rce.html)  
文章链接：<https://mrxn.net/jswz/youjiasoft-Other-picOnload-upload-rce.html>  
