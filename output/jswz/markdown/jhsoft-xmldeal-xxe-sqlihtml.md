...
![金和OA XmlDeal.aspx XXE+SQL注入漏洞](https://image.mrxn.net/b81ee0c8e0374a31a369fdf87b3889b3.webp)

![金和OA XmlDeal.aspx XXE+SQL注入漏洞](https://image.mrxn.net/b3b432f45d454633aff5394501b46071.webp)

## 任意文件夹删除

![金和OA XmlDeal.aspx XXE+SQL注入漏洞](https://image.mrxn.net/a2319585cd204745872413e991af8f41.webp)

## 硬编码的DES密钥

![金和OA XmlDeal.aspx XXE+SQL注入漏洞](https://image.mrxn.net/efc43c2578f545eaa19c138c8809d93b.webp)
...
![金和OA XmlDeal.aspx XXE+SQL注入漏洞](https://image.mrxn.net/2717331bf52c4dd0a3f322019ceaf880.webp)
...
![金和OA XmlDeal.aspx XXE+SQL注入漏洞](https://image.mrxn.net/592347322a0d4a47b74385f7eb9a9245.webp)
...
文章标题：
[金和OA XmlDeal.aspx XXE+SQL注入漏洞](https://mrxn.net/jswz/jhsoft-XmlDeal-xxe-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-XmlDeal-xxe-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-XmlDeal-xxe-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
