...
直接看
`FeedBackMgrController`
里关于
`queryFeedBackRecords`
的实现
...
![汉王e脸通综合管理平台 queryFeedBackRecords.do SQL注入漏洞](https://image.mrxn.net/d296486b219d4683a74a9a602893b3c4.webp)

和
[汉王e脸通综合管理平台 queryManyPeopleGroupList.do SQL注入漏洞](https://mrxn.net/jswz/hanvon-efacego-queryManyPeopleGroupList-sqli.html)
处理逻辑差不多，直接看对应的 mapper xml文件 FeedBackDsm.xml

![汉王e脸通综合管理平台 queryFeedBackRecords.do SQL注入漏洞](https://image.mrxn.net/0e90188531674379a56a2e90d9dfc12d.webp)
...
![汉王e脸通综合管理平台 queryFeedBackRecords.do SQL注入漏洞](https://image.mrxn.net/631778c7b9f1483f98eb278e250e3a1c.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-queryFeedBackRecords-sqli.html>
