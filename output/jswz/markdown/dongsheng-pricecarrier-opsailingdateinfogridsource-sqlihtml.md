...
东胜物流软件是青岛东胜伟业软件有限公司一款集订单管理、仓库管理、运输管理等多种功能于一体的物流管理软件。东胜物流信息管理系统 OpSailingDateInfoGridSource.aspx 接口存在
...
根据
`OpSailingDateInfoGridSource.aspx`
的代码引用
`DSWeb.PriceCarrier.OpSailingDateInfoGridSource`
，在dll中找到它的逻辑实现

![东胜物流软件 OpSailingDateInfoGridSource.aspx SQL注入漏洞](https://image.mrxn.net/4de4b8730a9b407580815d4ca67c9e85.webp)
...
![东胜物流软件 OpSailingDateInfoGridSource.aspx SQL注入漏洞](https://image.mrxn.net/20e25d345fd845b6ba31f4345e54cc1e.webp)
...
文章链接：
<https://mrxn.net/jswz/dongsheng-PriceCarrier-OpSailingDateInfoGridSource-sqli.html>
