...
好了，代码浅析完毕，写这篇文章的目的并不是来分析它，而是通过这个代码，我想到了用它在免杀方面的作用，如果某些EDR或者AV对代码进行分析时，如果走入这个逻辑中，是不是有可能也直接崩溃？这个代码也算是
...
文章标题：
[一段会迅速耗尽你机器内存的Java 代码](https://mrxn.net/jswz/java-OutOfMemoryError-code-to-dos.html)
  
文章链接：
<https://mrxn.net/jswz/java-OutOfMemoryError-code-to-dos.html>
