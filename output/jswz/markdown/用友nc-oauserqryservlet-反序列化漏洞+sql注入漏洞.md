...
文章标题：[用友NC OAUserQryServlet 反序列化漏洞+SQL注入漏洞](https://mrxn.net/jswz/yonyou-OAUserQryServlet-rce-sqli.html)  
文章链接：<https://mrxn.net/jswz/yonyou-OAUserQryServlet-rce-sqli.html>  
