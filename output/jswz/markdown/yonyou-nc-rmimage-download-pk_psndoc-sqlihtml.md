...
NC系统可利用/portal/pt/rmImage/download接口中的 pk\_psndoc 参数实现sql注入，从而窃取服务器的敏感信息。
...
通告可知SQL注入点在 rmImage 接口

![用友NC rmImage/download sql注入漏洞](https://image.mrxn.net/b0302f3340dd44d998aa036130d7565c.webp)
...
![用友NC rmImage/download sql注入漏洞](https://image.mrxn.net/b3e397c997d748928687a42f4caf1ac0.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-rmImage-download-pk_psndoc-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/yonyou-nc-rmImage-download-pk\_psndoc-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
