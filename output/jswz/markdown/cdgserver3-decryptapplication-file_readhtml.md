...
亿赛通电子文档安全管理系统的 DecryptApplication 接口ViewDecyptFile方法存在
[文件读取](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E8%AF%BB%E5%8F%96)
漏洞。攻击者可通过构造特定请求，利用该接口的
`decryptFileId`
、
`filePath`
等参数读取服务器上文件内容，从而获取敏感信息。
...
fileName由参数decryptFileId与当前路径进行拼接后使用
`new File (`
进行文件操作，获取基本信息与判断后进入
`CDGUtil.downFile`
方法
...
直接输出上面获取到的文件流信息到响应里，文件路径拼接过程中无任何过滤和校验，导致
[文件读取](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E8%AF%BB%E5%8F%96)
漏洞（有限）。

## ViewUploadFile

![亿赛通-电子文档安全管理系统 DecryptApplication 多个文件读取漏洞](https://image.mrxn.net/00d1e0dc28504806a51441a9080870de.webp)

![亿赛通-电子文档安全管理系统 DecryptApplication 多个文件读取漏洞](https://image.mrxn.net/cdd4d20327e747c48b1e9dee5dcddc97.webp)
...
![亿赛通-电子文档安全管理系统 DecryptApplication 多个文件读取漏洞](https://image.mrxn.net/ef25a8aa403842e6b575e8c15d36c8df.webp)
...
![亿赛通-电子文档安全管理系统 DecryptApplication 多个文件读取漏洞](https://image.mrxn.net/d91fc17b337544e1b71d4ed1bba721a0.webp)
...
文章标题：
[亿赛通-电子文档安全管理系统 DecryptApplication 多个文件读取漏洞](https://mrxn.net/jswz/CDGServer3-DecryptApplication-file_read.html)
  
文章链接：
<https://mrxn.net/jswz/CDGServer3-DecryptApplication-file_read.html>
