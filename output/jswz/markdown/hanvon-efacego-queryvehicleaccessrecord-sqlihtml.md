...
直接看
`VehicleAccessRecordController`
里关于
`queryVehicleAccessRecord`
的实现
...
处理逻辑差不多，直接看对应的 mapper xml文件 VehicleAccessRecordVesm.xml
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-queryVehicleAccessRecord-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/hanvon-efacego-queryVehicleAccessRecord-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
