...
`/data/manage/connect.php`
文件存在命令执行漏洞。未经身份验证的攻击者可以通过该漏洞在服务器端任意
[执行命令](https://mrxn.net/tag/rce)
，写入后门程序，获取服务器权限，进而控制整个Web服务器。
...
![NetMizer日志管理系统 connect.php 命令执行漏洞](https://image.mrxn.net/39e38810a0c44dd7b89db2cbaebb942d.webp)
...
文章链接：
<https://mrxn.net/jswz/netmizer-manage-connect-start-ifname-rce.html>
...
text: encodeURI("https://mrxn.net/jswz/netmizer-manage-connect-start-ifname-rce.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
