...
点为redeploy，通过搜索 redeploy 方法的定义即可找到所在文件

![用友NC M0dUlE/redeploy SQL注入漏洞](https://image.mrxn.net/aa740db2f53f4220822631a53e25329a.webp)
...
虽然
`if (!this.doCrc(id)) {`
有判断，但是仅仅打印错误，并没有终止进程，导致进入下一个逻辑后
`id`
直接拼接进SQL语句，造成SQL注入
...
![用友NC M0dUlE/redeploy SQL注入漏洞](https://image.mrxn.net/5b16a94dba62402199a59916a6e1b353.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-M0dUlE-redeploy-id-sqli.html>
