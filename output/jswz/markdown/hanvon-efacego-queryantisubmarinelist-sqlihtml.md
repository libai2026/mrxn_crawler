...
直接看
`AntisubmarineController`
里关于
`queryAntisubmarineList`
的实现
...
处理逻辑差不多，直接看对应的 mapper xml文件 AccessAntisubmarineDao.xml
...
![汉王e脸通综合管理平台 queryAntisubmarineList.do SQL注入漏洞](https://image.mrxn.net/ff80c2384685419ebe9e536cb0e87aa0.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-queryAntisubmarineList-sqli.html>
