...
文章标题：[金和OA getGovAIPDefineType.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-getGovAIPDefineType-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-getGovAIPDefineType-sqli.html>  
