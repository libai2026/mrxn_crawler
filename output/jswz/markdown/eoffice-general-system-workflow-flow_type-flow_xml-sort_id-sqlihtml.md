...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office flow\_xml.php 接口处存在
...
![泛微e-office flow_xml.php sql注入漏洞](https://image.mrxn.net/6227c8d81b7a462e9a41b06b2b24f9f3.webp)
...
文章标题：
[泛微e-office flow\_xml.php sql注入漏洞](https://mrxn.net/jswz/eoffice-general-system-workflow-flow_type-flow_xml-SORT_ID-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/eoffice-general-system-workflow-flow_type-flow_xml-SORT_ID-sqli.html>
