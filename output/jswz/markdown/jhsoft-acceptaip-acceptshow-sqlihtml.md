...
根据 AcceptShow.aspx 的源码，在 bin 目录下查找 JHBase.Web.AcceptAip.dll 将其进行反编译后找到
`AcceptShow`
的处理逻辑
...
![金和OA JHsoft.Web.AcceptAip/AcceptShow.aspx SQL注入漏洞](https://image.mrxn.net/2b6f5e4576e543588e091c4f3d3b6e67.webp)
...
文章标题：
[金和OA JHsoft.Web.AcceptAip/AcceptShow.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AcceptAip-AcceptShow-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AcceptAip-AcceptShow-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-AcceptAip-AcceptShow-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
