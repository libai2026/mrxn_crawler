...
文章标题：[用友NC OAContactsFuzzySearchServlet 反序列化漏洞+SQL注入漏洞](https://mrxn.net/jswz/yonyou-OAContactsFuzzySearchServlet-rce-sqli.html)  
文章链接：<https://mrxn.net/jswz/yonyou-OAContactsFuzzySearchServlet-rce-sqli.html>  
