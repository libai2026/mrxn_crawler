...
该系统的 /Easy7/rest/user/queryUserbyDesc 接口存在
...
再来看本次的漏洞接口 /Easy7/rest/user/queryUserbyDesc 对应的
`queryUserbyDesc()`
方法实现逻辑
...
继续跟进
`daoUser.queryUserbyDesc`
方法

![天地伟业Easy7 queryUserbyDesc SQL注入漏洞](https://image.mrxn.net/edb064c5b0594a9485ecd0abf3dec65c.webp)
...
![天地伟业Easy7 queryUserbyDesc SQL注入漏洞](https://image.mrxn.net/0b3e3f5c7c5d493f9a2a9e22d7601848.webp)
...
文章链接：
<https://mrxn.net/jswz/easy7-user-queryUserbyDesc-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/easy7-user-queryUserbyDesc-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
