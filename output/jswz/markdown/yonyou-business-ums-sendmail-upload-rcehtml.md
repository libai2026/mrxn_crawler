...
![用友U8+渠道管理(高级版) sendmail.jsp 文件上传漏洞](https://image.mrxn.net/c7e02dd14b054ecdaf84931546224db1.webp)
...
![用友U8+渠道管理(高级版) sendmail.jsp 文件上传漏洞](https://image.mrxn.net/ed4ee4b6cef74ae287f473a7bbd88d0c.webp)

访问上传文件

![用友U8+渠道管理(高级版) sendmail.jsp 文件上传漏洞](https://image.mrxn.net/c29b5a73adee47738729aec96a2c8536.webp)
...
文章标题：
[用友U8+渠道管理(高级版) sendmail.jsp 文件上传漏洞](https://mrxn.net/jswz/yonyou-business-ums-sendmail-upload-rce.html)
  
文章链接：
<https://mrxn.net/jswz/yonyou-business-ums-sendmail-upload-rce.html>
