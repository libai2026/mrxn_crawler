...
文章标题：[汉王e脸通综合管理平台 PermissionPersonController 多个SQL注入漏洞](https://mrxn.net/jswz/hanvon-efacego-accessPermissionPerson-sqli.html)  
文章链接：<https://mrxn.net/jswz/hanvon-efacego-accessPermissionPerson-sqli.html>  
