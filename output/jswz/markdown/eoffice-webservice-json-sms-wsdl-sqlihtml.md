...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office sms.wsdl.php 接口处存在
...
![泛微e-office sms.wsdl.php sql注入漏洞](https://image.mrxn.net/6f5786c6f8d841eda13eb275a55003f6.webp)

这里只拿第一个来简单过一遍

webservice-json/sms/sms.wsdl.php 的
`cancelNotifySmsRemind`
业务逻辑如下
...
![泛微e-office sms.wsdl.php sql注入漏洞](https://image.mrxn.net/4f2a2ec276cf4fd69cae1e679f8e0089.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-sms-wsdl-sqli.html>
