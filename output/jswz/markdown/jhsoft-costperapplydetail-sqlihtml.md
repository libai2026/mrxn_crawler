...
`CostPerApplyDetail.aspx`
、
`CostPerExpendDetail.aspx`
接口处存在
...
![金和OA CostPerApplyDetail.aspx、CostPerExpendDetail.aspx SQL注入漏洞](https://image.mrxn.net/992b205052ad45b4bbd7b693e9c3ad04.webp)

![金和OA CostPerApplyDetail.aspx、CostPerExpendDetail.aspx SQL注入漏洞](https://image.mrxn.net/50f9de4521024360b22920b1278da7b3.webp)
...
文章标题：
[金和OA CostPerApplyDetail.aspx、CostPerExpendDetail.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-CostPerApplyDetail-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-CostPerApplyDetail-sqli.html>
