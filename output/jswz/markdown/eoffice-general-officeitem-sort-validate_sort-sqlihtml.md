...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office validate\_sort.php 接口处存在
...
![泛微e-office validate_sort.php sql注入漏洞](https://image.mrxn.net/f2a4b28b5b67402ebe35c1cdc3766091.webp)

成功延时 5 秒

[sqlmap](https://mrxn.net/tag/sqlmap "sqlmap")
结果如下
...
文章标题：
[泛微e-office validate\_sort.php sql注入漏洞](https://mrxn.net/jswz/eoffice-general-officeitem-sort-validate_sort-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/eoffice-general-officeitem-sort-validate_sort-sqli.html>
