...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office attendance.wsdl.php 接口处存在
...
这是一个基于 PHP 的 SOAP 服务实现，它提供了两个主要的功能：
`SaveAttendance`
和
`GetLoginInOut`

浏览器打开
`/webservice-json/attendance/attendance.wsdl.php`
看下

![泛微e-office attendance.wsdl.php sql注入漏洞](https://image.mrxn.net/72585df8c95548119bd9780d618ff011.webp)

直接在 attendance.wsdl.php 后加上
`?wsdl`
再使用 SoapUI 或者 burp 的Wsdler 插件解析即可得到HTTP请求报文

![泛微e-office attendance.wsdl.php sql注入漏洞](https://image.mrxn.net/fba9e4f8bcc14791a53ebfbc5289fa9a.webp)
...
![泛微e-office attendance.wsdl.php sql注入漏洞](https://image.mrxn.net/caf25dbd00904a4c82809432a3bcb99c.webp)
...
![泛微e-office attendance.wsdl.php sql注入漏洞](https://image.mrxn.net/c81823e2160d425388ce14d14c3dcb6f.webp)

以及 sleep 2 秒 实际延时 8 秒

![泛微e-office attendance.wsdl.php sql注入漏洞](https://image.mrxn.net/a7f6b4a354e74e44a30f4567fa827cb1.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-attendance-attendance-wsdl-SaveAttendance-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/eoffice-webservice-json-attendance-attendance-wsdl-SaveAttendance-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
