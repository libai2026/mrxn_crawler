...
处理逻辑差不多，直接看对应的 mapper xml文件 SysAuthStrDsm.xml
...
![汉王e脸通综合管理平台 querySysAuthStr.do SQL注入漏洞](https://image.mrxn.net/52296e8f30e544128fc1072a64691b21.webp)
...
文章标题：
[汉王e脸通综合管理平台 querySysAuthStr.do SQL注入漏洞](https://mrxn.net/jswz/hanvon-efacego-querySysAuthStr-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-querySysAuthStr-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/hanvon-efacego-querySysAuthStr-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
