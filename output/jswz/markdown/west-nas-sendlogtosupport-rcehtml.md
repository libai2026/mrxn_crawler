...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS sendLogToSupport.php中存在
...
![西部数码 NAS php/sendLogToSupport.php 命令执行漏洞](https://image.mrxn.net/a4cb9901ff544f2c8dfddec375dbd55a.webp)
...
文章标题：
[西部数码 NAS php/sendLogToSupport.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-sendLogToSupport-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-sendLogToSupport-rce.html>
