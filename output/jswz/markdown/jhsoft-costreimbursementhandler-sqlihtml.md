...
金和网络是专业信息化服务商,为城市监管部门提供了互联网+监管解决方案,为企事业单位提供组织协同OA系统开发平台,电子政务一体化平台,智慧电商平台等服务。金和OA C6
`CostReimbursementHandler.ashx`
接口处存在
...
`CostReimbursementHandler.ashx`
的源码，在 bin 目录下查找
`JHBase.Web.CostControl.dll`
将其进行反编译后找到
**CostReimbursementHandler**
的处理逻辑
...
![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/1a15bfae9a0848b8bb66568e3279b6c1.webp)
...
`yeah`
被带入
`Get_Budget_PeriodDivertInformation`
方法
...
![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/fa9a4faea533477086b3f191a4ece0bf.webp)

![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/c0bd51919eab4ecc8c6211aac4f08b76.webp)

**GetYeahChangeAll**

![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/81ee25582bd242f0a9df5405ee0e9284.webp)

![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/6425178a493d4ca5affdac3d89dc158a.webp)

**getStandradForTravel**

![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/3b0f1fa8338b4cd8bd1ed151b9a45b2e.webp)

![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/d4e69e52f6ec4a35b1dfb2069fe30116.webp)
...
![金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://image.mrxn.net/0dd6e4ac67b54aa9ba15e2f2ab14f543.webp)
...
文章标题：
[金和OA CostReimbursementHandler.ashx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-CostReimbursementHandler-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-CostReimbursementHandler-sqli.html>
