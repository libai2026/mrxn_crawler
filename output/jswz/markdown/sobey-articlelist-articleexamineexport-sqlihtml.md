...
索贝产品中的 /sobey-mchEditor/mch/Articlelist/articleExamineExport 接口存在
...
根据漏洞信息看下
`mch/Articlelist/articleExamineExport`
的实现逻辑
...
和
**catalogids**
无任何过滤或校验处理，被直接拼接到qb这个sql语句中执行，从而造成了
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。
...
![索贝融媒体 /sobey-mchEditor/mch/Articlelist/articleExamineExport SQL注入漏洞](https://image.mrxn.net/12d1d301922d4666b0a2c70c3ba33b01.webp)
...
文章标题：
[索贝融媒体 /sobey-mchEditor/mch/Articlelist/articleExamineExport SQL注入漏洞](https://mrxn.net/jswz/sobey-Articlelist-articleExamineExport-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/sobey-Articlelist-articleExamineExport-sqli.html>
