...
东胜物流软件是青岛东胜伟业软件有限公司一款集订单管理、仓库管理、运输管理等多种功能于一体的物流管理软件。东胜物流信息管理系统 Chfee\_hexiao/GetDataList 接口存在
...
![东胜物流软件 Chfee_hexiao/GetDataList SQL注入漏洞](https://image.mrxn.net/b56f6648173a47a99c7a8905c2377ad9.webp)
...
文章标题：
[东胜物流软件 Chfee\_hexiao/GetDataList SQL注入漏洞](https://mrxn.net/jswz/dongsheng-Account-Chfee_hexiao-GetDataList-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/dongsheng-Account-Chfee_hexiao-GetDataList-sqli.html>
