---
title: "JeeWMS commonController.do 任意文件上传漏洞（CVE-2024-57761）"
source: https://mrxn.net/jswz/JeeWMS-commonController-upload-rce.html
---

# JeeWMS commonController.do 任意文件上传漏洞（CVE-2024-57761）

[Mrxn](https://mrxn.net/author/1)* 发表于2025/4/3 08:25
* 1479浏览
* [0评论](#comment)
* 1小时
  阅读
...
JeeWMS 是基于Java全栈技术打造的智能仓储中枢系统，具备多形态仓储场景深度适配能力（兼容3PL第三方物流与厂内物流双模式）。JeeWMS commonController.do 接口存在
[文件上传](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0)
漏洞，未经身份攻击者可通过该漏洞在服务器端任意执行代码，写入后门，获取服务器权限，进而控制整个 web 服务器。
...
![JeeWMS commonController.do 任意文件上传漏洞（CVE-2024-57761）](https://image.mrxn.net/226041ff2aac4d75acac94d09eaec070.webp)

可以明显看到官方修复之前是下面这样的，没有任何校验直接
[上传文件](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0)
，且文件保存在根目录下
...
所有以
`.do`
结尾的URL都会进入 spring 框架的核心控制器
`DispatcherServlet`
来负责处理所有MVC请求。再看下 spring-mvc.xml 的配置
...
![JeeWMS commonController.do 任意文件上传漏洞（CVE-2024-57761）](https://image.mrxn.net/67b98e6403254b5abefdba2db4c8f198.webp)
...
来获取用户请求URL作为
`requestPath`
，这个存在权限绕过问题，已经是老生长谈的问题了，可自行搜索相关文章。

那么最终修复版本里是如何处理的呢？

![JeeWMS commonController.do 任意文件上传漏洞（CVE-2024-57761）](https://image.mrxn.net/9860f20dbd444752b35f907fe343a5a0.webp)

使用正则判断 rest/ 路径后是否是正经URLpath，带有
`../`
以及
`;`
或者 多个
...
![JeeWMS commonController.do 任意文件上传漏洞（CVE-2024-57761）](https://image.mrxn.net/015e3e187e7949ee9e27050b4ab414a9.webp)

访问文件 /uid.jsp

![JeeWMS commonController.do 任意文件上传漏洞（CVE-2024-57761）](https://image.mrxn.net/d568106e113e474cbae2e54fd44351f6.webp)
...
文章链接：
<https://mrxn.net/jswz/JeeWMS-commonController-upload-rce.html>
...
text: encodeURI("https://mrxn.net/jswz/JeeWMS-commonController-upload-rce.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
