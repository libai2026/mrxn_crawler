...
东胜物流软件是青岛东胜伟业软件有限公司一款集订单管理、仓库管理、运输管理等多种功能于一体的物流管理软件。东胜物流信息管理系统 IPLimitController 接口存在
...
![东胜物流软件 IPLimitController SQL注入漏洞](https://image.mrxn.net/c02510f495e94a708074c16d4de77e98.webp)

如上图所示，参数name是被直接拼接进SQL语句中执行，从而造成
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。
...
![东胜物流软件 IPLimitController SQL注入漏洞](https://image.mrxn.net/9183fb368f67420f80ecfa53a7468dbc.webp)
...
文章链接：
<https://mrxn.net/jswz/dongsheng-IPLimit-UpdateIPAddress-sqli.html>
