...
`Dec 24 10:55:03 mrxn.guest mysqld[536]:
...
然后Google搜索上面的红色关键词：Couldn't find MySQL server (/usr/bin/mysqld\_safe) ... failed! ，借鉴这个的方法
<http://www.cnblogs.com/olinux/p/5546371.html>
...
文章标题：
[emlog,连接数据库失败,请检查数据库信息,错误编号 2002](https://mrxn.net/jswz/emlog-mysql-2002error-solved.html)
  
文章链接：
<https://mrxn.net/jswz/emlog-mysql-2002error-solved.html>
