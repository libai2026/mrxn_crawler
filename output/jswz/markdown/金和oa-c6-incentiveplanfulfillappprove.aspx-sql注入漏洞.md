...
文章标题：[金和OA C6 IncentivePlanFulfillAppprove.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-IncentivePlan-httpOID-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-IncentivePlan-httpOID-sqli.html>  
