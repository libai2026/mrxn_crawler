...
，并确保路径以
`\`
开头。然后判断是否存在文件路径，存在就直接读取文件内容并响应在body中，期间对
`object2`
无其余过滤或校验检查，因此造成任意文件读取
[漏洞](https://mrxn.net/tag/%E6%BC%8F%E6%B4%9E)
。

需要注意的是请求格式，因为并不是走的URL参数，不支持
...
![时空智友企业流程化管控系统 updater.getStudioFile 任意文件读取漏洞](https://image.mrxn.net/a4f735d2eff34552853727786bde7758.webp)
...
![时空智友企业流程化管控系统 updater.getStudioFile 任意文件读取漏洞](https://image.mrxn.net/91b8412726e345ff99d4fcd760f787e7.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-updater-getStudioFile-fileread.html>
...
text: encodeURI("https://mrxn.net/jswz/yonyou-updater-getStudioFile-fileread.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
