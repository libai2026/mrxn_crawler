...
直接看
`AuthMultiplePeopleOpenController`
里关于
`getGroupEmployee`
的实现
...
处理逻辑差不多，直接看对应的 mapper xml文件 AccesManyPeopleGroupDao.xml
...
![汉王e脸通综合管理平台 getGroupEmployee.do SQL注入漏洞](https://image.mrxn.net/ba75dd3cc9d941f991fca065ad7c8ae3.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-getGroupEmployee-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/hanvon-efacego-getGroupEmployee-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
