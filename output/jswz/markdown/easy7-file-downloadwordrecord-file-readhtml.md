...
该系统的/Easy7/rest/file/downloadWordRecord接口存在前台任意
...
再来看本次的漏洞接口 /Easy7/rest/file/downloadWordRecord 的对应方法
`downloadWordRecord()`
的实现逻辑
...
中配置的
`file_path_znxc`
的值，是固定的，然后将用户传递的参数fileName作为文件路径一部分传递进
...
![天地伟业Easy7 downloadWordRecord 文件读取漏洞](https://image.mrxn.net/43d012ea039342a09c1472b1af8e187b.webp)
...
文章链接：
<https://mrxn.net/jswz/easy7-file-downloadWordRecord-file-read.html>
...
text: encodeURI("https://mrxn.net/jswz/easy7-file-downloadWordRecord-file-read.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
