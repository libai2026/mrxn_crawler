...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS noHDD.php中存在
...
时，从请求中获取
`enable`
参数，在未进行任何过滤或转义的情况下，直接将其拼接到 $setCmd中，然后用
`exec()`
函数执行的系统命令中，导致了
...
![西部数码 NAS php/noHDD.php 命令执行漏洞](https://image.mrxn.net/fdb2c0e3847a47db8d39f5d232e880b2.webp)
...
文章标题：
[西部数码 NAS php/noHDD.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-noHDD-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-noHDD-rce.html>
...
text: encodeURI("https://mrxn.net/jswz/west-nas-noHDD-rce.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
