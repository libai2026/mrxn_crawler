...
`exportMeetingEmployeeRecordExcel.do`
接口存在
...
里关于
`exportMeetingEmployeeRecordExcel`
的实现
...
处理逻辑差不多，直接看对应的 mapper xml文件 MeetingEmployeeDsm.xml
...
![汉王e脸通综合管理平台 exportMeetingEmployeeRecordExcel.do SQL注入漏洞](https://image.mrxn.net/77b3864fb3234531a4ebdcb31aa0030b.webp)
...
文章标题：
[汉王e脸通综合管理平台 exportMeetingEmployeeRecordExcel.do SQL注入漏洞](https://mrxn.net/jswz/hanvon-efacego-exportMeetingEmployeeRecordExcel-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-exportMeetingEmployeeRecordExcel-sqli.html>
