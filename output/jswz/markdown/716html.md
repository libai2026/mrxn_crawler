---
title: "冰蝎Behinder 4.1 双击提示:本地机器上没有找到编译环境"
source: https://mrxn.net/jswz/716.html
---

# 冰蝎Behinder 4.1 双击提示:本地机器上没有找到编译环境

[Mrxn](https://mrxn.net/author/1)* 发表于2023/8/27 12:42
* 12750浏览
* [8评论](#comment)
* 6分钟
  阅读
...
前几天冰蝎更新了4.1 版本,新版本更新后 直接双击 Behinder.jar 提示
`本地机器上没有找到编译环境，为了正常使用自定义传输协议功能，请使用JDK（而非JRE）环境打开本软件。`
.习惯双击启动的可能不是特别适应去软件目录命令行启动,最终在t00ls看到了解决方案,分享给大家,也方便大家.
  
[![冰蝎Behinder 4.1 双击提示:本地机器上没有找到编译环境](https://mrxn.net/content/uploadfile/202308/832e1693111870.png)](https://mrxn.net/content/uploadfile/202308/832e1693111870.png)
...
文章标题：
[冰蝎Behinder 4.1 双击提示:本地机器上没有找到编译环境](https://mrxn.net/jswz/716.html)
  
文章链接：
<https://mrxn.net/jswz/716.html>
...
text: encodeURI("https://mrxn.net/jswz/716.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
