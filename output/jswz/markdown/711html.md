---
title: "一键激活mac安装版本的burpsuite pro"
source: https://mrxn.net/jswz/711.html
---

# 一键激活mac安装版本的burpsuite pro

[Mrxn](https://mrxn.net/author/1)* 发表于2023/6/18 21:28
* 9334浏览
* [0评论](#comment)
* 32分钟
  阅读
...
初始原因是每次升级完
[burpsuite](//mrxn.net/tag/burpsuite "burpsuite")
pro 都需要重新去走一遍激活流程（这里或许是我的环境原因？）
  
正好看到 h3110w0r1d-y 的 BurpLoaderKeygen 项目前不久更新了，支持命令行激活！那就干脆写一个
[shell](//mrxn.net/tag/shell "shell")
脚本，方便后续使用或者第一次安装使用。
...
考虑到GitHub在部分地区的可用性，我优先使用了代理的来加载和下载。
...
激活
[脚本](//mrxn.net/tag/%E8%84%9A%E6%9C%AC "脚本")
运行截图

![一键激活mac安装版本的burpsuite pro](https://user-images.githubusercontent.com/18260135/246666969-6cf49959-ffc7-4a8f-8b13-cfec84213533.png)

更多信息（linux、windows）可以查看
[github](//mrxn.net/tag/github "github")
:
<https://github.com/Mr-xn/burpsuite_pro_for_mac>

BurpLoaderKeygen.jar 下载:
[BurpLoaderKeygen.jar](https://mrxn.net/content/uploadfile/202308/3ef21691155956.jar)
...
文章标题：
[一键激活mac安装版本的burpsuite pro](https://mrxn.net/jswz/711.html)
  
文章链接：
<https://mrxn.net/jswz/711.html>
...
text: encodeURI("https://mrxn.net/jswz/711.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
