...
继续跟进
`GetUserPublishSystemTableByUserID`
方法
...
![金和OA GroupUserSynchState.aspx SQL注入漏洞](https://image.mrxn.net/4b6b3c5a93d1422893f3dd48d8594d6f.webp)
...
文章标题：
[金和OA GroupUserSynchState.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-GroupUserSynchState-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-GroupUserSynchState-sqli.html>
