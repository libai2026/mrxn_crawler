...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS usb\_backup.php中存在
...
![西部数码 NAS usb_backup.php 命令执行漏洞](https://image.mrxn.net/f6edba94e1a94fc3aa6b657701f840a9.webp)
...
![西部数码 NAS usb_backup.php 命令执行漏洞](https://image.mrxn.net/9f3d97b46f98424b8809359c78e988e6.webp)
...
文章标题：
[西部数码 NAS usb\_backup.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-usb_backup-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-usb_backup-rce.html>
