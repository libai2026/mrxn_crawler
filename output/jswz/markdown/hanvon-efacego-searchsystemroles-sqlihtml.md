...
处理逻辑差不多，直接看对应的 mapper xml文件 SystemDsm.xml
...
![汉王e脸通综合管理平台 searchSystemRoles.do SQL注入漏洞](https://image.mrxn.net/ddee2766a9084a44ad1ecc1a385b94f8.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-searchSystemRoles-sqli.html>
