...
和
`$start`
来自用户输入，未经过任何过滤或转义。这些参数在命令构建过程中直接插入，造成
...
![NetMizer日志管理系统 qq.php 命令执行漏洞](https://image.mrxn.net/910a589657f4434dbe89d301e4876450.webp)
...
文章链接：
<https://mrxn.net/jswz/netmizer-search-qq-start-rce.html>
