---
title: "emlog pro 后台邮件通知不支持 Outlook 邮箱修复"
source: https://mrxn.net/jswz/692.html
---

# emlog pro 后台邮件通知不支持 Outlook 邮箱修复

[Mrxn](https://mrxn.net/author/1)* 发表于2022/6/19 22:23
* 5597浏览
* [0评论](#comment)
* 19分钟
  阅读
...
缘起是博客的邮件通知插件突然挂掉了，在修的过程中，发现后台有个邮件通知功能，主要是用于找回密码，注册验证这类作用，测试了下也不行，就顺手修复了在此小计（
~~水文~~
）一篇
...
此种协议的安全相关参考此文:
[电子邮件环境下STARTTLS的安全性分析](https://www.4hou.com/posts/m8B3)
...
`$mail->SMTPSecure`
设置的值为 SSL :
[L308](https://github.com/emlog/emlog/blob/0d5995798d6389743d5312db77169c709cfd0c8c/admin/setting.php#L308)
...
[![emlog pro 后台邮件通知不支持 Outlook 邮箱修复](https://mrxn.net/content/uploadfile/202206/thum-d8151655650494.jpg)](https://mrxn.net/content/uploadfile/202206/d8151655650494.jpg)

注释原有的设置，添加两行判断分别设置一下即可正常使用 Outlook 邮箱发信。

> PS：也需要注意邮箱密码带有特殊符号，在设置处传递到后端的时候被
> `转义`
...
文章标题：
[emlog pro 后台邮件通知不支持 Outlook 邮箱修复](https://mrxn.net/jswz/692.html)
  
文章链接：
<https://mrxn.net/jswz/692.html>
...
text: encodeURI("https://mrxn.net/jswz/692.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
