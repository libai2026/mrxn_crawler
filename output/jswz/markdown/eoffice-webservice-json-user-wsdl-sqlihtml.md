...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office user.wsdl.php 接口处存在
...
![泛微e-office user.wsdl.php sql注入漏洞](https://image.mrxn.net/dce11fc648a241119b5a546aa270b650.webp)

这里只拿第一个来简单过一遍

webservice-json/user/user.wsdl.php 的
`DeleteUser`
业务逻辑如下
...
![泛微e-office user.wsdl.php sql注入漏洞](https://image.mrxn.net/fe0a7674d5d048b2aac93e7256873c29.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-user-wsdl-sqli.html>
