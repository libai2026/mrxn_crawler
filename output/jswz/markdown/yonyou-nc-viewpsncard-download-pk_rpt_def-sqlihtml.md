...
NC系统可利用/portal/pt/viewPsnCard/download接口中的 pk\_rpt\_def 参数实现sql注入，从而窃取服务器的敏感信息。
...
最终调用 executeQuery 执行拼接的SQL语句，造成
...
![用友NC viewPsnCard/download sql注入漏洞](https://image.mrxn.net/5f1a7c1a7f7b4818bea18fd6ee50226f.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-viewPsnCard-download-pk_rpt_def-sqli.html>
