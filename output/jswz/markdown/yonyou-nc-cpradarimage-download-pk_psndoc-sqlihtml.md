...
NC系统/portal/pt/cpRadarImage/download接口中的pk\_psndoc参数实现
...
通告可知SQL注入点在 cpRadarImage 接口

![用友NC cpRadarImage/download sql注入漏洞](https://image.mrxn.net/b167cbaa4b864789af5dc0ee8d14041e.webp)
...
直接将 pk\_psndoc 拼接进SQL语句中，然后将拼接后的SQL语句带入 retrieveByClause 函数后最终还是使用 executeQuery 来执行SQL语句，无任何过滤或校验，造成
...
![用友NC cpRadarImage/download sql注入漏洞](https://image.mrxn.net/4c643607620741a793e0b7c310931abd.webp)
...
![用友NC cpRadarImage/download sql注入漏洞](https://image.mrxn.net/1074b14a0e834701bcf2f872ab2ef880.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-cpRadarImage-download-pk_psndoc-sqli.html>
