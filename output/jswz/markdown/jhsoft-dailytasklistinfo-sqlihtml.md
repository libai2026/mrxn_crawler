...
`bin`
目录下查找
`JHSoft.Web.DailyTaskManage.dll`
将其进行反编译后找到
`DailyTaskListInfo`
的处理逻辑

![金和OA DailyTaskListInfo.aspx SQL注入漏洞](https://image.mrxn.net/cc93d803844b4f13a71dd9f4e7b13d31.webp)
...
复现需要访问 DailyTaskListInfo.aspx 页面获取需要的其他参数及其值

![金和OA DailyTaskListInfo.aspx SQL注入漏洞](https://image.mrxn.net/a1cff4bbeb854e2496b1bf1030f4814f.webp)
...
![金和OA DailyTaskListInfo.aspx SQL注入漏洞](https://image.mrxn.net/5a70d8b9af3948e796ae74c5ce76e274.webp)

延时 10 秒（执行两次）

![金和OA DailyTaskListInfo.aspx SQL注入漏洞](https://image.mrxn.net/c0cc1adf10d44716b77d38adaebfa0fb.webp)
...
文章链接：
<https://mrxn.net/jswz/jhsoft-DailyTaskListInfo-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-DailyTaskListInfo-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
