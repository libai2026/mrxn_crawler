...
到这里就比较明了，最终这个参数
`itemid`
是未经过任何过滤或校验就被直接拼接到sql语句中进行执行从而造成
[SQL注入漏洞](https://mrxn.net/tag/SQL注入)
。
...
![用友NC ActivityNotice/export SQL注入漏洞](https://image.mrxn.net/8005184003a547a89bc2c34d9d2d7d17.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-ActivityNotice-export-sqli.html>
