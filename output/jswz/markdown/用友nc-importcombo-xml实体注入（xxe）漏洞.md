...
文章标题：[用友NC importCombo XML实体注入（XXE）漏洞](https://mrxn.net/jswz/yonyou-nc-portalcombo-importCombo-xxe.html)  
文章链接：<https://mrxn.net/jswz/yonyou-nc-portalcombo-importCombo-xxe.html>  
