...
文章标题：[金和OA ModuleTaskView.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-ModuleTaskView-OriginID-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-ModuleTaskView-OriginID-sqli.html>  
