...
文章标题：[友加畅捷管理系统 Service/ms\_DBLis 未授权访问致信息泄露漏洞](https://mrxn.net/jswz/youjiasoft-Service-ms_DBList-data-leak.html)  
文章链接：<https://mrxn.net/jswz/youjiasoft-Service-ms_DBList-data-leak.html>  
