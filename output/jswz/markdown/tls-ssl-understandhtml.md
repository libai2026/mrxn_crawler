...
，如果你想快速自建CA然后签发数字证书，请移步

[基于OpenSSL自建CA和颁发SSL证书](https://mrxn.net/openssl-self-sign-ca.html)
...
[![SSL/TLS原理详解](https://mrxn.net/content/uploadfile/201509/thum-b2f81443106791.png "点击查看原图")](https://mrxn.net/content/uploadfile/201509/b2f81443106791.png)
...
* **TLS**
  ...
  TLS 1.0是IETF（Internet Engineering Task Force，Internet工程任务组）制定的一种新的协议，它建立在SSL 3.0协议规范之上，是SSL 3.0的后续版本，可以理解为SSL 3.1，它是写入了
  [RFC](http://tools.ietf.org/html/rfc5246)
  的。该协议由两层组成： TLS 记录协议（TLS Record）和 TLS 握手协议（TLS Handshake）。较低的层为 TLS 记录协议，位于某个可靠的传输协议（例如 TCP）上面。
...
[![SSL/TLS原理详解](https://mrxn.net/content/uploadfile/201509/thum-3b4d1443107053.jpg "点击查看原图")](https://mrxn.net/content/uploadfile/201509/3b4d1443107053.jpg)
...
[![SSL/TLS原理详解](https://mrxn.net/content/uploadfile/201509/thum-09d01443107108.jpg "点击查看原图")](https://mrxn.net/content/uploadfile/201509/09d01443107108.jpg)
...
关于PreMaster Secret(Key)的计算请参考
[Https SSL/TLS PreMaster/Master Secret(Key)计算](http://www.fenesky.com/blog/2014/07/25/how-premaster-secret.html)
。
...
[![SSL/TLS原理详解](https://mrxn.net/content/uploadfile/201509/937f1443107150.jpg "点击查看原图")](https://mrxn.net/content/uploadfile/201509/937f1443107150.jpg)
...
关于Session Secret(Key)的计算请参考
[Https SSL/TLS Session Secret(Key)计算](http://www.fenesky.com/blog/2014/07/25/how-session-secret.html)
。
...
SecurityPortal在2000年底有一份文章《The End of SSL and SSH?》激起了很多的讨论， 目前也有一些成熟的工具如dsniff（
...
当在浏览器里设置了https的代理，而且里输入了
`https://www.example.com`
之后，浏览器会与proxy建立tcp链接，然后向其发出这么一段消息：
...
CA证书以及如何使用OpenSSL自签署，见文章
[OpenSSL自签署证书](http://seanlook.com/2015/01/15/openssl-self-sign-ca)
。
...
<http://seanlook.com/2015/01/07/tls-ssl-understand/>
(国外，需要梯子请在本博客搜索，关键字：查资料)
...
文章标题：
[SSL/TLS原理详解](https://mrxn.net/jswz/tls-ssl-understand.html)
  
文章链接：
<https://mrxn.net/jswz/tls-ssl-understand.html>
