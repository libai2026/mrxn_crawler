...
参数
`str`
过滤不完善导致经过认证的用户可向系统写入任意内容到任意文件造成
...
![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/5c87fa3498f7481abae9849f11dfc9ad.webp)
...
![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/a46122d8afdc4a96b7bec9941853959f.webp)

# 漏洞分析

我们尝试写入
[一句话](https://mrxn.net/tag/%E4%B8%80%E5%8F%A5%E8%AF%9D)
webshell ,不出意外被拦截了

![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/ce4867ea1a394125b42e0c4e7c9a44b9.webp)
...
![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/b82a9c0099264fffb2ba351c55912da4.webp)

访问 cmd.php 并执行
`phpinfo()`
成功

![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/719c93a6ff5c4fb2b7fc703cf441cbb0.webp)
...
![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/7c0f9423e5ee4b97b1d6f8395ab1c54c.webp)

也是可以成功上传的且成功执行的

![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/0fbd6380be3140718e8bb54ff00e9f35.webp)
...
![DedeCMS V5.7.117（最新版） RCE](https://image.mrxn.net/f2b9847eec6c4a4c8588ace0776eabdf.webp)
...
文章链接：
<https://mrxn.net/jswz/DedeCMS-V5_7_117-RCE.html>
