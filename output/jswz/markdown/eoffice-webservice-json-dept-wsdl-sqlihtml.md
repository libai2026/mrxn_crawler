...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office dept.wsdl.php 接口处存在
...
![泛微e-office dept.wsdl.php sql注入漏洞](https://image.mrxn.net/e7c35cc50b3a42cf8bd507415cac8b35.webp)

webservice-json/dept/dept.wsdl.php 的
`DeleteDept`
业务逻辑如下
...
![泛微e-office dept.wsdl.php sql注入漏洞](https://image.mrxn.net/a0a80da311b64fe4b87fe016aba5eddd.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-dept-wsdl-sqli.html>
