...
九佳易管理系统中的 picHY.ashx 通用处理程序接口存在
...
`string str = this.Request["hyh"];`
无任何过滤或校验被直接拼接到
`$"SELECT top 1 default_disp FROM da_hy_pic where hyh='{str}'"`
sql语句中，然后调用
`dbHelp.QueryRDataTable()`
方法进行执行，从而造成
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。
...
![九佳易管理系统 picHY.ashx SQL 注入漏洞](https://image.mrxn.net/481649191cb140528b3f2b93c74b44a2.webp)
...
文章链接：
<https://mrxn.net/jswz/a8erp-HuiYuanDangAn-picHY-sqli.html>
