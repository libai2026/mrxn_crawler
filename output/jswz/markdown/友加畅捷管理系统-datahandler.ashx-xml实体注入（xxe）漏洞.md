...
文章标题：[友加畅捷管理系统 DataHandler.ashx XML实体注入（XXE）漏洞](https://mrxn.net/jswz/youjiasoft-Report-DataHandler-xxe.html)  
文章链接：<https://mrxn.net/jswz/youjiasoft-Report-DataHandler-xxe.html>  
