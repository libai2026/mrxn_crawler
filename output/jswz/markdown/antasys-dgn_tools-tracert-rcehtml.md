...
对获取的
`$trace_ip_addr`
进行单双引号反斜杠以及null字符进行转义（添加反斜杠），命令注入时需要注意。其次是判断
`$trace_ip_addr`
的长度小于等于50就直接拼接进 system函数进行
...
![汉塔科技上网行为管理系统 tracert.php 命令注入漏洞](https://image.mrxn.net/2e6e1ae43cab4258a5e579498daf0c43.webp)

![汉塔科技上网行为管理系统 tracert.php 命令注入漏洞](https://image.mrxn.net/5a861560f42e4ad88b6530fb06aa9353.webp)
...
威盾PHP解密，批量解密：
`https://gist.github.com/Mr-xn/2c749d160cb4b7460b504c9cf0376ec6`
...
文章链接：
<https://mrxn.net/jswz/antasys-dgn_tools-tracert-rce.html>
