...
`Jhsoft.Web.Archives/XmlHttp.aspx`
接口处存在
...
`bin`
目录下查找
`JHSoft.Web.Archives.dll`
将其进行反编译后找到
**ArchivesRoomDeptSave**
的处理逻辑
...
![金和OA Jhsoft.Web.Archives/XmlHttp.aspx XXE+SQL注入漏洞](https://image.mrxn.net/2717331bf52c4dd0a3f322019ceaf880.webp)
...
![金和OA Jhsoft.Web.Archives/XmlHttp.aspx XXE+SQL注入漏洞](https://image.mrxn.net/41e58921ba3d4b82a98345c8664d5b7c.webp)
...
文章标题：
[金和OA Jhsoft.Web.Archives/XmlHttp.aspx XXE+SQL注入漏洞](https://mrxn.net/jswz/jhsoft-Archives-XmlHttp-xxe-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-Archives-XmlHttp-xxe-sqli.html>
