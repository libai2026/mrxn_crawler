...
处理逻辑差不多，直接看对应的 mapper xml文件 PatrolRecordDsm.xml
...
![汉王e脸通综合管理平台 getAllRecord.do SQL注入漏洞](https://image.mrxn.net/336f1e51dffd48aa90f40fe0ce936a32.webp)

![汉王e脸通综合管理平台 getAllRecord.do SQL注入漏洞](https://image.mrxn.net/27f3cc150f3348eb8652f46f34ee27b2.webp)
...
![汉王e脸通综合管理平台 getAllRecord.do SQL注入漏洞](https://image.mrxn.net/1b3c2834c62148e0b7499beae579b2ac.webp)

条件不等时

![汉王e脸通综合管理平台 getAllRecord.do SQL注入漏洞](https://image.mrxn.net/660e3a5d45ff4ec5b32ee2c4cc62e4b5.webp)
...
文章标题：
[汉王e脸通综合管理平台 getAllRecord.do SQL注入漏洞](https://mrxn.net/jswz/hanvon-efacego-getAllRecord-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-getAllRecord-sqli.html>
