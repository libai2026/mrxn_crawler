...
该系统的 /Easy7/rest/workbook/queryDataByTypeEx 接口存在
...
再来看本次的漏洞接口 /Easy7/rest/workbook/queryDataByTypeEx 对应的
`queryDataByTypeEx()`
方法实现逻辑
...
继续跟进
`daoWorkBook.queryDataByTypeEx(voPage.getTabname())`
方法

![天地伟业Easy7 queryDataByTypeEx SQL注入漏洞](https://image.mrxn.net/5014933c669a48989690e64dfd858c45.webp)

最终在dao层，参数
`tabname`
是未经任何过滤或校验直接拼接在SQL语句中执行，从而造成
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。
...
![天地伟业Easy7 queryDataByTypeEx SQL注入漏洞](https://image.mrxn.net/692d14e1ec034384845b6fd202394058.webp)
...
文章链接：
<https://mrxn.net/jswz/easy7-workbook-queryDataByTypeEx-sqli.html>
