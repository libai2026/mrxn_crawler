...
该系统的/Easy7/rest/file/downloadNote接口存在前台任意
...
再来看本次的漏洞接口 /Easy7/rest/file/downloadNote 的对应方法
`downloadNote()`
的实现逻辑
...
其中
`path = CLS_Easy7_Types.file_path;`
为应用的根目录，然后将用户传递的参数
`fileName`
作为文件路径一部分传递进
...
![天地伟业Easy7 downloadNote 文件读取漏洞](https://image.mrxn.net/a2a2d4eb2ef14175a7df8aa4c4cb4c07.webp)
...
文章链接：
<https://mrxn.net/jswz/easy7-file-downloadNote-file-read.html>
