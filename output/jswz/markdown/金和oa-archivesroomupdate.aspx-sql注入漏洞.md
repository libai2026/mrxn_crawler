...
文章标题：[金和OA ArchivesRoomUpdate.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-ArchivesRoomUpdate-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-ArchivesRoomUpdate-sqli.html>  
