...
保存文件的文件名和和文件后缀（类型）均有用户控制，全程无过滤和校验，造成任意
[文件上传漏洞](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0)
。
...
![汉王e脸通综合管理平台 resourceUploadFile.do 任意文件上传漏洞](https://image.mrxn.net/d6d359b1ef9642aaa8dded509ab0ebfc.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-dgmCommand-resourceUploadFile-rce.html>
