...
文章标题：[东胜物流软件 CompanysAccountGridSource.aspx SQL注入漏洞](https://mrxn.net/jswz/dongsheng-Shipping-CompanysAccountGridSource-sqli.html)  
文章链接：<https://mrxn.net/jswz/dongsheng-Shipping-CompanysAccountGridSource-sqli.html>  
