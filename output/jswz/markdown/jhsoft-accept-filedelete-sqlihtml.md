...
根据 FileDelete.aspx 的源码，在 bin 目录下查找 JHBase.Web.accept.dll 将其进行反编译后找到
`FileDelete`
的处理逻辑
...
![金和OA FileDelete.aspx SQL注入漏洞](https://image.mrxn.net/1561ff6e97644836a3e3ff3c64d3036f.webp)
...
文章标题：
[金和OA FileDelete.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-accept-FileDelete-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-accept-FileDelete-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-accept-FileDelete-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
