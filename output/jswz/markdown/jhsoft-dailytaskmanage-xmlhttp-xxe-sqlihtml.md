...
`Jhsoft.Web.dailytaskmanage/XmlHttp.aspx`
接口处存在
...
被直接拼接进
`ExecSqlReDt`
SQL语句中执行，无任何过滤或校验，导致
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。

否则根据 TermType 的值分别进入
`GetMonthTaskOEC`
方法
...
![金和OA dailytaskmanage/XmlHttp.aspx XXE漏洞+SQL注入漏洞](https://image.mrxn.net/e39e9ee505e7449e8f92bd98c024bb35.webp)
...
![金和OA dailytaskmanage/XmlHttp.aspx XXE漏洞+SQL注入漏洞](https://image.mrxn.net/cd4dc186409247168f5e67897a1a2d44.webp)
...
文章标题：
[金和OA dailytaskmanage/XmlHttp.aspx XXE漏洞+SQL注入漏洞](https://mrxn.net/jswz/jhsoft-dailytaskmanage-XmlHttp-xxe-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-dailytaskmanage-XmlHttp-xxe-sqli.html>
