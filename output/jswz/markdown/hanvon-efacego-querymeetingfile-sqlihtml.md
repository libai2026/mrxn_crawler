...
处理逻辑差不多，直接看对应的 mapper xml文件 MeetingFileDsm.xml
...
> 需要一个合法的 token，参考
> [wxLogin.do 信息泄露](https://mrxn.net/jswz/hanvon-efacego-wxLogin-auth-bypass-data-leak.html "wxLogin.do 信息泄露")
> 获取
>
> 需要 mtId 参数存在
...
![汉王e脸通综合管理平台 queryMeetingFile.do SQL注入漏洞](https://image.mrxn.net/b550dcd431934f2ab9564fbc9db91f8e.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-queryMeetingFile-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/hanvon-efacego-queryMeetingFile-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
