...
灵当CRM是一款专为中小企业打造的智能客户关系管理工具，由上海灵当信息科技有限公司开发并运营。广泛应用于金融、教育、医疗、IT服务、房地产等多个行业领域，帮助企业实现客户个性化管理需求，提升企业竞争力。无论是新客户开拓、老客户维护，还是销售过程管理、服务管理等方面，灵当CRM都能提供全面、高效的解决方案。灵当CRM /crm/upload.php 接口存在任意
...
根据
`$_FILES`
数组获取上传文件，将其保存到指定目录中,无任何过滤处理，导致任意文件上传
...
![灵当CRM /crm/upload.php 文件上传漏洞](https://image.mrxn.net/b36dd68a03b44419acf52f9001977c76.webp)
...
文章链接：
<https://mrxn.net/jswz/51mis-upload-rce.html>
