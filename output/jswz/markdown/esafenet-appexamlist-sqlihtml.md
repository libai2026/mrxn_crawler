...
亿赛通电子文档安全管理系统的AppExamList.jsp接口存在
[SQL注入漏洞](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
。攻击者可以通过构造特定的POST请求，在多个参数如username、AppTate、startTime、endTime中注入恶意SQL代码，利用该漏洞对数据库执行任意SQL操作。攻击者可以通过注入WAITFOR DELAY命令，导致数据库响应时间延迟，从而确认
...
多个参数如username、startTime、endTime这些会被带入
...
、
`endTime`
等全程未经任何过滤和校验就被直接拼接进sql语句中进行执行，从而导致
[sql注入漏洞](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
。
...
![亿赛通电子文档安全管理系统 AppExamList.jsp SQL注入漏洞](https://image.mrxn.net/0542ff74495340bea3adb6e367cca094.webp)
...
文章链接：
<https://mrxn.net/jswz/esafenet-AppExamList-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/esafenet-AppExamList-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
