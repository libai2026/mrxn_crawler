...
`bin`
目录下查找
`JHBase.Web.ExamineNod.dll`
将其进行反编译后找到
**AttendWorkAttendance**
的处理逻辑
...
![金和OA AttendWorkAttendance.aspx SQL注入漏洞](https://image.mrxn.net/7b245661e3064f6587e26b23f665a0f4.webp)
...
文章标题：
[金和OA AttendWorkAttendance.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AttendWorkAttendance-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AttendWorkAttendance-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-AttendWorkAttendance-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
