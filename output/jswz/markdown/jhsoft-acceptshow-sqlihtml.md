...
根据 AcceptShow.aspx 的源码，在 bin 目录下查找 JHBase.Web.accept.dll 将其进行反编译后找到
`AcceptShow`
的处理逻辑
...
![金和OA AcceptShow.aspx SQL注入漏洞](https://image.mrxn.net/4b2dd2d62bc14d65a886a5db77c3dc89.webp)
...
文章标题：
[金和OA AcceptShow.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AcceptShow-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AcceptShow-sqli.html>
