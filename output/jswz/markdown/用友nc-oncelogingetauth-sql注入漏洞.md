...
文章标题：[用友NC oncelogin/getAuth SQL注入漏洞](https://mrxn.net/jswz/yonyou-nc-oncelogin-getAuth-sqli.html)  
文章链接：<https://mrxn.net/jswz/yonyou-nc-oncelogin-getAuth-sqli.html>  
