...
普华PowerPMS是上海普华科技发展股份有限公司旗下一款项目管理信息平台。其PowerPMS系统GetFilesData接口存在
...
![普华Powerpms GetFilesData SQL注入漏洞](https://image.mrxn.net/a29dc94ae1994aef8801ad5d65e03a37.webp)

同时可以看到
`EpsProjId`
参数被直接拼接进SQL语句中执行，无过滤或校验，因此造成
[SQL注入漏洞](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
，就是朴实无华。
...
![普华Powerpms GetFilesData SQL注入漏洞](https://image.mrxn.net/218f07b4ccf04b6294396fbc2147dc40.webp)
...
文章链接：
<https://mrxn.net/jswz/powerpms-UploadFle-GetFilesData-sqli.html>
