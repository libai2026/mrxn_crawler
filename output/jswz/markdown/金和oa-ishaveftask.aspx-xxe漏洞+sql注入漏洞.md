...
文章标题：[金和OA IsHaveFTask.aspx XXE漏洞+SQL注入漏洞](https://mrxn.net/jswz/jhsoft-IsHaveFTask-XXE-TaskIDList-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-IsHaveFTask-XXE-TaskIDList-sqli.html>  
