...
文章标题：[天锐绿盾审批系统 /ext/app/fileopen/record、list fastjson反序列化漏洞](https://mrxn.net/jswz/trwfe-fileopen-record-rce.html)  
文章链接：<https://mrxn.net/jswz/trwfe-fileopen-record-rce.html>  
