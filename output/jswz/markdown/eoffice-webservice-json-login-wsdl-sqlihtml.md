...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office login.wsdl.php 接口处存在
...
![泛微e-office login.wsdl.php sql注入漏洞](https://image.mrxn.net/089f781d1d3b462f8092c26bda4b5f71.webp)

webservice-json/login/login.wsdl.php 的
`UserLogin`
业务逻辑如下
...
![泛微e-office login.wsdl.php sql注入漏洞](https://image.mrxn.net/ef65f87832c94e2e9ec941c801e77e12.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-webservice-json-login-wsdl-sqli.html>
