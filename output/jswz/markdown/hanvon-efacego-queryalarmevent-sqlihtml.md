...
处理逻辑差不多，直接看对应的 mapper xml文件 AlarmStatusDao.xml
...
![汉王e脸通综合管理平台 queryAlarmEvent.do SQL注入漏洞](https://image.mrxn.net/39fe0a8ce92f41fbb3f8ddc3edb8815f.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-queryAlarmEvent-sqli.html>
