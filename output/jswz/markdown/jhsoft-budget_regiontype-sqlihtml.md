...
`RegionID`
被带入
`Get_Budget_RegionTypeInfomationByID`
方法
...
![金和OA Budget_RegionType.aspx SQL注入漏洞](https://image.mrxn.net/14820c48be0d42d58156e4e8845add71.webp)
...
文章标题：
[金和OA Budget\_RegionType.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-Budget_RegionType-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-Budget_RegionType-sqli.html>
