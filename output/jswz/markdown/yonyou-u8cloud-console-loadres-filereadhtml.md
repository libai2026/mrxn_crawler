...
U8 Cloud是用友推出的云ERP，主要聚焦成长型、创新型企业，提供企业级云ERP整体解决方案。是基于全新的企业互联网理念设计的云ERP系统，它旨在为企业提供集人财物客产供销于一体的云ERP整体解决方案，推动企业敏经营、轻管理、简IT，助力企业实现高速发展与云化创新。用友U8 Cloud /hrss/dorado/console.loadRes.d 接口处存在任意
...
![用友U8 Cloud console.loadRes.d 任意文件读取漏洞](https://image.mrxn.net/cd5ee531020c4b779729b86c4c0754dc.webp)
...
调用 loader 读取文件后直接响应在body，无任何过滤，造成任意文件读取
...
文章链接：
<https://mrxn.net/jswz/yonyou-u8cloud-console-loadRes-fileread.html>
...
text: encodeURI("https://mrxn.net/jswz/yonyou-u8cloud-console-loadRes-fileread.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
