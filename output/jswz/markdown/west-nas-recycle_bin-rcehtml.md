...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS recycle\_bin.php中存在
...
**popen**
来执行拼接后的
[命令](https://mrxn.net/tag/rce)
。尽管此漏洞需要管理员权限才能触发，但可以结合
`login_check`
的权限绕过达到 RCE的效果。
...
![西部数码 NAS recycle_bin.php 命令执行漏洞](https://image.mrxn.net/5e2ecd7ae08d4939a03b067e3a8c866a.webp)
...
文章标题：
[西部数码 NAS recycle\_bin.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-recycle_bin-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-recycle_bin-rce.html>
...
text: encodeURI("https://mrxn.net/jswz/west-nas-recycle\_bin-rce.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
