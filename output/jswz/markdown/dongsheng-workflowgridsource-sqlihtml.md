...
东胜物流软件是青岛东胜伟业软件有限公司一款集订单管理、仓库管理、运输管理等多种功能于一体的物流管理软件。东胜物流信息管理系统 WorkFlowGridSource.aspx 接口存在SQL注入漏洞，未经身份验证的远程攻击者除了可以利用
...
根据
`WorkFlowGridSource.aspx`
的代码引用
`DSWeb.WorkFlow.WorkFlowGridSource`
，在dll中找到它的逻辑实现
...
![东胜物流软件 WorkFlowGridSource.aspx SQL注入漏洞](https://image.mrxn.net/1f3cc9f047754836a562a35b98dd551f.webp)
...
文章链接：
<https://mrxn.net/jswz/dongsheng-WorkFlowGridSource-sqli.html>
