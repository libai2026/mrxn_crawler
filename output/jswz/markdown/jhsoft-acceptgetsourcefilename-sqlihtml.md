...
根据 AcceptGetSourceFileName.aspx 的源码，在 bin 目录下查找 JHBase.Web.AcceptAip.dll 将其进行反编译后找到
`AcceptGetSourceFileName`
的处理逻辑
...
![金和OA AcceptGetSourceFileName.aspx SQL注入漏洞](https://image.mrxn.net/7bfe442ee0b64ec690cc4e69028c193b.webp)
...
文章标题：
[金和OA AcceptGetSourceFileName.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AcceptGetSourceFileName-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AcceptGetSourceFileName-sqli.html>
