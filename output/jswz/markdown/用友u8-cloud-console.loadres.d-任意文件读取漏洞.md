...
文章标题：[用友U8 Cloud console.loadRes.d 任意文件读取漏洞](https://mrxn.net/jswz/yonyou-u8cloud-console-loadRes-fileread.html)  
文章链接：<https://mrxn.net/jswz/yonyou-u8cloud-console-loadRes-fileread.html>  
