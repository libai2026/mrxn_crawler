...
文章标题：[百易云资产管理运营系统 feeStandard.Apply.save2.php SQL注入漏洞](https://mrxn.net/jswz/baiyishequ-adminx-feeStandard-Apply-save2-sqli.html)  
文章链接：<https://mrxn.net/jswz/baiyishequ-adminx-feeStandard-Apply-save2-sqli.html>  
