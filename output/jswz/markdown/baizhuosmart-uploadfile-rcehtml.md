...
`uploadfile.php`
接口存在任意
[文件上传](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0 "任意文件上传")
漏洞。未经身份验证的攻击者可以利用此
...
从 POST请求获取
`txt_path`
的值作为文件储存路径（需要一个可写权限的目录），上传里的filename随意，上传文件name部分为
`file_upload`
即可实现任意文件上传致RCE效果。
...
![百卓Smart管理平台 uploadfile.php 文件上传漏洞](https://image.mrxn.net/a9f0669c38624074810e3e53f619ce51.webp)
...
![百卓Smart管理平台 uploadfile.php 文件上传漏洞](https://image.mrxn.net/8796782214c14dccb5732831e193a2bb.webp)
...
文章链接：
<https://mrxn.net/jswz/baizhuosmart-uploadfile-rce.html>
