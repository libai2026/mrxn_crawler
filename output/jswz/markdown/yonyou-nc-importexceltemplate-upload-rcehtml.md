...
NC的importExcelTemplate模块存在任意
[文件上传](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0)
漏洞。攻击者可通过构造恶意上传请求，绕过文件类型限制，将任意文件上传至服务器，进而可能实现
...
![用友NC importExcelTemplate 任意文件上传漏洞](https://image.mrxn.net/9945f3e8d4d740199ae6d03032875687.webp)

直接搜索发现有三处实现了该方法

![用友NC importExcelTemplate 任意文件上传漏洞](https://image.mrxn.net/59442d87c6484f38affa6ccf1d231141.webp)
...
整个类就一个action,也就是存在漏洞的方法
`importExcelTemplate`
，
`importExcelTemplate`
的实现也比较简单，直接将请求里的文件文件信息如文件名这些原封不动的取出来，然后调用
**FileUtils.writeByteArrayToFile**
写入文件，整个过程没有任何对文件的类型、后缀以及内容的校验措施，因此造成任意
[文件上传](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E4%B8%8A%E4%BC%A0)
漏洞。
...
![用友NC importExcelTemplate 任意文件上传漏洞](https://image.mrxn.net/4195ea315fa542dfb9d615b42a8f5238.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-importExcelTemplate-upload-rce.html>
