---
title: "Synway SMG网关管理软件 9-12ping.php 远程代码执行漏洞（CVE-2025-1448）"
source: https://mrxn.net/jswz/synway-9-12ping-rce.html
---

# Synway SMG网关管理软件 9-12ping.php 远程代码执行漏洞（CVE-2025-1448）

[Mrxn](https://mrxn.net/author/1)* 发表于2025/3/6 08:40
* 1351浏览
* [0评论](#comment)
* 38分钟
  阅读
...
在Synway SMG网关管理软件（版本至2025年2月4日）中发现了一个严重漏洞。该漏洞影响某些未知的文件处理过程，特别是名为“9-12ping.php”的文件。由于参数“retry”的处理不当，导致
...
、
`retry`
均是直接拼接进system函数的命令里进行执行，造成命令注入
...
![Synway SMG网关管理软件 9-12ping.php 远程代码执行漏洞（CVE-2025-1448）](https://image.mrxn.net/393fdde175f840fc8a98baa7f7282150.webp)
...
文章链接：
<https://mrxn.net/jswz/synway-9-12ping-rce.html>
...
text: encodeURI("https://mrxn.net/jswz/synway-9-12ping-rce.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
