...
上海孚盟软件有限公司是一家专业的外贸SaaS服务和行业解决方案提供商。其旗下产品孚盟云
`GetDropDownListContent.ashx`
接口存在
...
![孚盟云CRM GetDropDownListContent.ashx SQL注入漏洞](https://image.mrxn.net/c8aeb63c54374710ad0bcd07ac624ef5.webp)

根据参数
`action`
的值进入不同的处理逻辑，可以看到众多的处理分支，其中当
**action=getType**
时，处理逻辑如下
...
即参数
`UserID`
也是被直接拼接在SQL语句中执行，同样造成SQL注入漏洞。

以及
**action=getUnit**

![孚盟云CRM GetDropDownListContent.ashx SQL注入漏洞](https://image.mrxn.net/c84ca94f9ab140e8a997ed93d63e179e.webp)

![孚盟云CRM GetDropDownListContent.ashx SQL注入漏洞](https://image.mrxn.net/ae2b99f4d55e431fb3d38708bfc3734f.webp)

参数
`uid`
也是同样被直接拼接进SQL语句执行，也存在
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞
...
![孚盟云CRM GetDropDownListContent.ashx SQL注入漏洞](https://image.mrxn.net/89a7c6f2e6e34e6885a183e36e181f8a.webp)
...
![孚盟云CRM GetDropDownListContent.ashx SQL注入漏洞](https://image.mrxn.net/0b18fa7b704f42149fcb3e4b026ad579.webp)
...
文章标题：
[孚盟云CRM GetDropDownListContent.ashx SQL注入漏洞](https://mrxn.net/jswz/fumacrm-GetDropDownListContent-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/fumacrm-GetDropDownListContent-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/fumacrm-GetDropDownListContent-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
