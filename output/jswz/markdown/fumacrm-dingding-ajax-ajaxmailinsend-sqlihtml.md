...
上海孚盟软件有限公司是一家专业的外贸SaaS服务和行业解决方案提供商。其旗下产品孚盟云AjaxMailInSend.ashx接口存在多个
...
当
**action=autoMailTranRuler**
时，看下
`NoAutoMailTranRuler`
方法的实现

![孚盟云CRM AjaxMailInSend.ashx 多个SQL注入漏洞](https://image.mrxn.net/381d6a00b09743caac2b90bd89d91fc8.webp)
...
![孚盟云CRM AjaxMailInSend.ashx 多个SQL注入漏洞](https://image.mrxn.net/ed00e642944943b18ad2026ec08723f6.webp)
...
![孚盟云CRM AjaxMailInSend.ashx 多个SQL注入漏洞](https://image.mrxn.net/65850bbda50849efb4466e5020b369e8.webp)
...
文章标题：
[孚盟云CRM AjaxMailInSend.ashx 多个SQL注入漏洞](https://mrxn.net/jswz/fumacrm-Dingding-Ajax-AjaxMailInSend-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/fumacrm-Dingding-Ajax-AjaxMailInSend-sqli.html>
