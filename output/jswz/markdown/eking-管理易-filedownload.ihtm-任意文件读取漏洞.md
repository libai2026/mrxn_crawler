...
文章标题：[EKing-管理易 FileDownload.ihtm 任意文件读取漏洞](https://mrxn.net/jswz/eking-FileDownload-handleFileDownload.html)  
文章链接：<https://mrxn.net/jswz/eking-FileDownload-handleFileDownload.html>  
