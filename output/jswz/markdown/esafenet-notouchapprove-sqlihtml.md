...
亿赛通电子文档安全管理系统的notouchapprove.jsp接口存在
[SQL注入漏洞](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
。攻击者可以通过构造特定的POST请求，在多个参数id中注入恶意SQL代码，利用该漏洞对数据库执行任意SQL操作。攻击者可以通过注入WAITFOR DELAY命令，导致数据库响应时间延迟，从而确认
...
其主要目的就是组装sql语句，可见参数
`id`
全程未经任何过滤和校验就被直接拼接进sql语句中进行执行，从而导致
[sql注入漏洞](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
。
...
![亿赛通电子文档安全管理系统 notouchapprove.jsp SQL注入漏洞](https://image.mrxn.net/719cb8dea7c74f649ce4e68851bbd51f.webp)
...
文章标题：
[亿赛通电子文档安全管理系统 notouchapprove.jsp SQL注入漏洞](https://mrxn.net/jswz/esafenet-notouchapprove-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/esafenet-notouchapprove-sqli.html>
