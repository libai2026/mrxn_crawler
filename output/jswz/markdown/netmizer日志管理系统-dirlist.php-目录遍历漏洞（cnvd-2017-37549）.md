...
文章标题：[NetMizer日志管理系统 dirlist.php 目录遍历漏洞（CNVD-2017-37549）](https://mrxn.net/jswz/netmizer-data-manage-dirlist-node-directory-traversal.html)  
文章链接：<https://mrxn.net/jswz/netmizer-data-manage-dirlist-node-directory-traversal.html>  
