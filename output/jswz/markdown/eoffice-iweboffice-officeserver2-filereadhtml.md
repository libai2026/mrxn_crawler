...
和
`RECORDID`
参数用户可控且无任何过滤或校验，导致可以拼接任意文件路径进行文件操作。
...
![泛微e-office OfficeServer2.php 文件读取漏洞](https://image.mrxn.net/068fed3161d84ffbbd238e7425589026.webp)
...
![泛微e-office OfficeServer2.php 文件读取漏洞](https://image.mrxn.net/7a4b05355f764b81ad1e470b6db7bb5c.webp)
...
![泛微e-office OfficeServer2.php 文件读取漏洞](https://image.mrxn.net/27b9d59548604f7fa4a7735711200ce4.webp)
...
文章链接：
<https://mrxn.net/jswz/eoffice-iWebOffice-OfficeServer2-fileread.html>
