...
根据 AcceptGetFileName.aspx 的源码，在 bin 目录下查找 JHBase.Web.accept.dll 将其进行反编译后找到
`AcceptGetFileName`
的处理逻辑
...
参数
`SlaveID`
被直接拼接进SQL语句中后执行，无任何过滤或校验，导致
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。

JHsoft.Web.AcceptAip 下的 AcceptGetFileName 也存在同样的问题

![金和OA AcceptGetFileName.aspx、AcceptGetFileNameAndPath.aspx SQL注入漏洞](https://image.mrxn.net/9c6113cbff95489c88a63aeb00cce53b.webp)

AcceptGetFileNameAndPath.aspx 也是如此

![金和OA AcceptGetFileName.aspx、AcceptGetFileNameAndPath.aspx SQL注入漏洞](https://image.mrxn.net/6b7b08d04ea848ac81f80c2136f05fb1.webp)
...
![金和OA AcceptGetFileName.aspx、AcceptGetFileNameAndPath.aspx SQL注入漏洞](https://image.mrxn.net/a5d885987f7841bb83f5f19122a2cdda.webp)
...
![金和OA AcceptGetFileName.aspx、AcceptGetFileNameAndPath.aspx SQL注入漏洞](https://image.mrxn.net/eef4368412d441a38e5bbdf967e3d986.webp)
...
文章标题：
[金和OA AcceptGetFileName.aspx、AcceptGetFileNameAndPath.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AcceptAcceptGetFileName-AcceptGetFileNameAndPath-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/jhsoft-AcceptAcceptGetFileName-AcceptGetFileNameAndPath-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-AcceptAcceptGetFileName-AcceptGetFileNameAndPath-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
