...
文章标题：[金和OA AppraiseScoreUpdate.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AppraiseScoreUpdate-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-AppraiseScoreUpdate-sqli.html>  
