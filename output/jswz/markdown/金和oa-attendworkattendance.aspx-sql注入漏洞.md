...
文章标题：[金和OA AttendWorkAttendance.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-AttendWorkAttendance-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-AttendWorkAttendance-sqli.html>  
