...
[Mrxn](https://mrxn.net/author/1)* 发表于2026/1/17 08:31
* 210浏览
* [0评论](#comment)
* 24分钟
  阅读
...
上海孚盟软件有限公司是一家专业的外贸SaaS服务和行业解决方案提供商。其旗下产品孚盟云AjaxCustomizeReport.ashx接口存在多个
...
当
**action=GetCustomizeReportSelectItem**
时，一样的存在SQL注入漏洞

![孚盟云CRM AjaxCustomizeReport.ashx SQL注入漏洞](https://image.mrxn.net/81139837a0154fb69f85685802bc7168.webp)
...
![孚盟云CRM AjaxCustomizeReport.ashx SQL注入漏洞](https://image.mrxn.net/5dc6c5bebec045a89dcd7160f3091092.webp)
...
文章标题：
[孚盟云CRM AjaxCustomizeReport.ashx SQL注入漏洞](https://mrxn.net/jswz/fumacrm-Dingding-Ajax-AjaxCustomizeReport-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/fumacrm-Dingding-Ajax-AjaxCustomizeReport-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/fumacrm-Dingding-Ajax-AjaxCustomizeReport-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
