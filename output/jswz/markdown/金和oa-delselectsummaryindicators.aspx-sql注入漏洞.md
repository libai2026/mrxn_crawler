...
文章标题：[金和OA DelSelectSummaryIndicators.aspx SQL注入漏洞](https://mrxn.net/jswz/jhsoft-DelSelectSummaryIndicators-sqli.html)  
文章链接：<https://mrxn.net/jswz/jhsoft-DelSelectSummaryIndicators-sqli.html>  
