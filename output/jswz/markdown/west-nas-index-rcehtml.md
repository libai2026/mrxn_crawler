...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS index.php中Cookie存在
...
![西部数码 NAS index.php 命令执行漏洞](https://image.mrxn.net/fbb3399b3ddc41558a90f88006b19827.webp)
...
![西部数码 NAS index.php 命令执行漏洞](https://image.mrxn.net/555d5c70d32343d18b8fb5cdd70f3298.webp)
...
文章标题：
[西部数码 NAS index.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-index-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-index-rce.html>
