...
![Unibox路由器 network/checkstatus_ping.php 命令执行漏洞](https://image.mrxn.net/f73465e16cdb4c748a5ac78eb715e93e.webp)
...
文章标题：
[Unibox路由器 network/checkstatus\_ping.php 命令执行漏洞](https://mrxn.net/jswz/unibox-network-checkstatus_ping-rce.html)
