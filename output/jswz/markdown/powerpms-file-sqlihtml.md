...
跟进
`BeginProcess.BeginProcessRequest`
...
`action`
执行具体操作，当
`action=download、browser、topdf、delete`
等时，
...
![普华Powerpms File.ashx SQL注入漏洞](https://image.mrxn.net/26da1db5dc3a40008274d7822f858284.webp)
...
文章标题：
[普华Powerpms File.ashx SQL注入漏洞](https://mrxn.net/jswz/powerpms-File-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/powerpms-File-sqli.html>
