...
该系统的 /Easy7/rest/obj/getActiveEffectTemp 接口存在
...
再来看本次的漏洞接口 /Easy7/rest/obj/getActiveEffectTemp 对应的
`getActiveEffectTemp()`
方法实现逻辑
...
`id`
被直接带入
`boInquestRoom.getActiveEffectTemp`
方法
...
继续跟进
`daoInquestRoom.getActiveEffectTemp`
方法

![天地伟业Easy7 getActiveEffectTemp SQL注入漏洞](https://image.mrxn.net/140ac740b59642e6a5a8372425fbe78c.webp)

最终在dao层，参数
`id`
是未经任何过滤或校验直接拼接在IN自查询SQL语句中执行，从而造成
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。
...
![天地伟业Easy7 getActiveEffectTemp SQL注入漏洞](https://image.mrxn.net/e767cdcca3a54c5d8d49e31cf9a34f96.webp)
...
文章链接：
<https://mrxn.net/jswz/easy7-obj-getActiveEffectTemp-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/easy7-obj-getActiveEffectTemp-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
