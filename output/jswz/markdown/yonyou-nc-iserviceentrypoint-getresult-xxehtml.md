...
⽤友NC IServiceEntryPoint 接⼝处存在
[XXE](https://mrxn.net/tag/XXE)
漏洞，未授权的攻击者可以通过此漏洞读取服务器上敏感⽂件，进 ⼀步利⽤可导致服务器失陷。
...
对 xml 内容进行操作，而JAXB的
`Unmarshaller`
默认启用外部实体解析功能，未对XML输入中的实体引用进行限制，造成
[XXE](https://mrxn.net/tag/XXE)
漏洞。
...
![用友NC IServiceEntryPoint XXE漏洞](https://image.mrxn.net/1996db71b511443ca42b5b9b92f32c1f.webp)
...
文章链接：
<https://mrxn.net/jswz/yonyou-nc-IServiceEntryPoint-getResult-xxe.html>
