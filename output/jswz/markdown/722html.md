---
title: ".NET RSA 算法的 XML 格式简介及其转换 PEM 格式"
source: https://mrxn.net/jswz/722.html
---

# .NET RSA 算法的 XML 格式简介及其转换 PEM 格式

[Mrxn](https://mrxn.net/author/1)* 发表于2024/4/9 22:39
* 5115浏览
* [0评论](#comment)
* 24分钟
  阅读
...
最近
[代码审计](https://mrxn.net/tag/代码审计 "代码审计")
遇到了源码硬编码了公私钥,趁机学习一下 .NET 中的 RSA 算法的 XML格式及其互转常见的 PEM 格式
...
也可以使用在线的 XML 转 PEM 格式工具,如
<https://www.ssleye.com/ssltool/pem_xml.html>
  
转换后即可使用 常用的RSA工具进行加解密,如
...
text: encodeURI("https://mrxn.net/jswz/722.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
