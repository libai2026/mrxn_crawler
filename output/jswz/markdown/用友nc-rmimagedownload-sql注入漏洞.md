...
文章标题：[用友NC rmImage/download sql注入漏洞](https://mrxn.net/jswz/yonyou-nc-rmImage-download-pk_psndoc-sqli.html)  
文章链接：<https://mrxn.net/jswz/yonyou-nc-rmImage-download-pk_psndoc-sqli.html>  
