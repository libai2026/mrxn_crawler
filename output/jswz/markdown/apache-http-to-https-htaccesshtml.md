...
[![Apache下设置自动将http跳转到https方法](https://mrxn.net/content/uploadfile/201512/thum-b5721449057345.jpg "点击查看原图")](https://mrxn.net/content/uploadfile/201512/b5721449057345.jpg)

一行一条命令，其实就是利用伪静态将访问者跳转到443端口，从而实现了http到https的跳转。

**注：**

此为虚拟机的方法，推荐使用服务器自己配置https，虚拟机的这样配置后，有可能导致蜘蛛不能抓取你的网站，对SEO不好，慎重选择！
...
文章标题：
[Apache下设置自动将http跳转到https方法](https://mrxn.net/jswz/Apache-http-to-https-htaccess.html)
  
文章链接：
<https://mrxn.net/jswz/Apache-http-to-https-htaccess.html>
