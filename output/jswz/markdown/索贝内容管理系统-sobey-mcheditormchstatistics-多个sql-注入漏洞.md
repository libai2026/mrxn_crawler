...
文章标题：[索贝内容管理系统 /sobey-mchEditor/mch/statistics 多个SQL 注入漏洞](https://mrxn.net/jswz/sobey-statistics-wxarticleList-sqli.html)  
文章链接：<https://mrxn.net/jswz/sobey-statistics-wxarticleList-sqli.html>  
