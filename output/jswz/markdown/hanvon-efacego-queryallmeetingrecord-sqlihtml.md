...
直接看
`MobiMeetingAppController`
里关于
`queryAllMeetingRecord`
的实现
...
处理逻辑差不多，直接看对应的 mapper xml文件 MeetingDsm.xml
...
> 需要一个合法的 token，参考
> [wxLogin.do 信息泄露](https://mrxn.net/jswz/hanvon-efacego-wxLogin-auth-bypass-data-leak.html)
> 获取
...
![汉王e脸通综合管理平台 queryAllMeetingRecord.do SQL注入漏洞](https://image.mrxn.net/3748707ccf4440e989b1ff17906fb8cd.webp)
...
文章标题：
[汉王e脸通综合管理平台 queryAllMeetingRecord.do SQL注入漏洞](https://mrxn.net/jswz/hanvon-efacego-queryAllMeetingRecord-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-queryAllMeetingRecord-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/hanvon-efacego-queryAllMeetingRecord-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
