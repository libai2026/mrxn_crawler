...
后来检查Edit--Virtual Network Editor...，进去以后看到VMnet0 Bridged Auto-bridging - - - ，点选VMnet0，在VMnet Information里面，点击“Bridged to: ”后面的“Automatic”下拉菜单，发现有两个网卡，一个是[VPN](#)的，一个物理网卡。果断将“Automatic”更换为物理网卡，重新启动Centos系统，久违的IP回来了。
