...
Western Digital MyCloud NAS是一款网络附加存储设备，旨在提供集中存储和共享解决方案。它允许用户在家中或办公室通过网络访问文件，支持多种设备的备份和共享。Western Digital MyCloud NAS internal\_backup.php中存在
...
![西部数码 NAS internal_backup.php 命令执行漏洞](https://image.mrxn.net/51282b8190714f64bcfc2d3f10d9564a.webp)

go\_restore

![西部数码 NAS internal_backup.php 命令执行漏洞](https://image.mrxn.net/f791fd3909c34bca8a31d802186bdbbc.webp)

go\_jobs

![西部数码 NAS internal_backup.php 命令执行漏洞](https://image.mrxn.net/76000b20f71e4ebe95131364435f7159.webp)

del

![西部数码 NAS internal_backup.php 命令执行漏洞](https://image.mrxn.net/f08e6833ed184b7ebeba2ef02c615dde.webp)
...
![西部数码 NAS internal_backup.php 命令执行漏洞](https://image.mrxn.net/3230b12ab3a844c5b567ff69aec5dcc4.webp)
...
文章标题：
[西部数码 NAS internal\_backup.php 命令执行漏洞](https://mrxn.net/jswz/west-nas-internal_backup-rce.html)
  
文章链接：
<https://mrxn.net/jswz/west-nas-internal_backup-rce.html>
