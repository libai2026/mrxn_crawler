...
一直抓不到真正发起DNS请求的进程原因是在 Windows 系统中，大多数 [DNS 查询](https://mrxn.net/tag/DNS%E8%A7%A3%E6%9E%90 "DNS 查询")都是由 svchost.exe 中的 DNS 客户端服务进行的.
...
文章标题：[如何在 Windows 7 (win7) 系统上追踪发起DNS请求的进程](https://mrxn.net/jswz/how-to-find-dns-query-process-on-win7.html)  
文章链接：<https://mrxn.net/jswz/how-to-find-dns-query-process-on-win7.html>  
