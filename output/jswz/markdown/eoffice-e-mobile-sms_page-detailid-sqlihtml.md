...
E-Office是一款标准化的协同 OA 办公软件，泛微协同办公产品系列成员之一,实行通用化产品设计，充分贴合企业管理需求，本着简洁易用、高效智能的原则，为企业快速打造移动化、无纸化、数字化的办公平台。泛微e-office sms\_page.php 接口处存在
...
和
`$keyWord`
均是直接拼接进SQL语句中并使用 exequery 直接执行，无任何过滤，造成SQL注入
...
![泛微e-office sms_page.php sql注入漏洞](https://image.mrxn.net/f44c34052d9949fea0f979b04d4139b4.webp)
...
文章标题：
[泛微e-office sms\_page.php sql注入漏洞](https://mrxn.net/jswz/eoffice-E-mobile-sms_page-detailid-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/eoffice-E-mobile-sms_page-detailid-sqli.html>
