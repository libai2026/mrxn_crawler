...
处理逻辑差不多，直接看对应的 mapper xml文件 PatrolTeamDsm.xml
...
![汉王e脸通综合管理平台 getEmployeeByTeamId.do SQL注入漏洞](https://image.mrxn.net/ba681d687b9444409938c8aede944dbb.webp)

条件不等时

![汉王e脸通综合管理平台 getEmployeeByTeamId.do SQL注入漏洞](https://image.mrxn.net/58b72d72bd924d1abfc86bfb22cd274a.webp)
...
文章标题：
[汉王e脸通综合管理平台 getEmployeeByTeamId.do SQL注入漏洞](https://mrxn.net/jswz/hanvon-efacego-getEmployeeByTeamId-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-getEmployeeByTeamId-sqli.html>
