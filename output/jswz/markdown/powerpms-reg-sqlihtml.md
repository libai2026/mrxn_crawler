...
普华PowerPMS是上海普华科技发展股份有限公司旗下一款项目管理信息平台。其PowerPMS系统Reg.ashx接口存在SQL注入漏洞，攻击者除了可以利用
...
当
**hum**
参数不为空且长度大于0时，进入Power.Systems.StdSystem.HumanBO使用FindByKey来查找，这个属于老熟人了。使用FindByKey查找，无过滤或校验，因此造成
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞，就是朴实无华。
...
![普华Powerpms Reg.ashx SQL注入漏洞](https://image.mrxn.net/fffe07381a914af8a3ef32786d27a52e.webp)
...
文章标题：
[普华Powerpms Reg.ashx SQL注入漏洞](https://mrxn.net/jswz/powerpms-Reg-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/powerpms-Reg-sqli.html>
