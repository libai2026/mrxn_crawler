...
直接根据 DealXml.aspx 在 bin 目录下查找 JHSoft.Web.Appraise.dll 将其进行反编译后找到
`DealXml`
的处理逻辑
...
![金和OA DealXml.aspx XXE漏洞](https://image.mrxn.net/3c4e418dd4c74201b148398cef7e9368.webp)
...
文章链接：
<https://mrxn.net/jswz/jhsoft-DealXml-xxe.html>
...
text: encodeURI("https://mrxn.net/jswz/jhsoft-DealXml-xxe.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
