...
变量在后续构建
`$sqldevice`
字符串时，未经任何安全处理（如转义或参数化查询）便直接拼接到SQL查询语句
`and nodeid = $device`
中。这使得攻击者能够构造恶意的SQL代码片段，通过
`$newdevicezone`
参数注入到最终执行的SQL查询中，造成
...
![NetMizer日志管理系统 terminals.php SQL注入漏洞](https://image.mrxn.net/f8738f83c23a4111b9057f456a563eae.webp)
...
文章链接：
<https://mrxn.net/jswz/netmizer-data-echart-terminals-device-sqli.html>
