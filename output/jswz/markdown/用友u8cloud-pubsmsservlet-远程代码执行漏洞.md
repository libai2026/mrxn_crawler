...
文章标题：[用友U8Cloud pubsmsservlet 远程代码执行漏洞](https://mrxn.net/jswz/yonyou-pubsmsservlet-xstream-rce.html)  
文章链接：<https://mrxn.net/jswz/yonyou-pubsmsservlet-xstream-rce.html>  
