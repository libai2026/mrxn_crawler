...
）拼接进命令字符串中，并通过
`popen($cmd, "r")`
执行。该过程未对用户输入进行任何过滤或转义，导致攻击者可以通过这些参数注入额外的命令，造成
...
![NetMizer日志管理系统 mail.php 命令执行漏洞](https://image.mrxn.net/a4c22958edf5475f9f62364882165314.webp)
...
文章链接：
<https://mrxn.net/jswz/netmizer-search-mail-nodeid-rce.html>
