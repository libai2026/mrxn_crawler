...
![Googlebot | Bingbot IP 验证工具](https://image.mrxn.net/aba3b5d2063b4c8fa14ae1ea391544a8.gif)

导出结果查看详细检查内容

![Googlebot | Bingbot IP 验证工具](https://image.mrxn.net/b2f557adc6ef4cb2b393b495e851da14.webp)
...
2. **性能优化设计**
   ...
   * **CIDR缓存**
     ：网段数据本地存储24小时，减少90%冗余请求
   * **结果缓存**
     ：IP验证结果存储7天，支持离线查看历史记录
   * **请求调度**
     ：自动暂停/恢复机制防止资源过载
3. **容错机制**
...
![Googlebot | Bingbot IP 验证工具](https://image.mrxn.net/390948d826d24238897df87300a6997a.webp)

其中实时检测部分有
**四重校验逻辑**
，如下图所示

![Googlebot | Bingbot IP 验证工具](https://image.mrxn.net/8d4162f29d5041d285ee77e4aa14b4c5.webp)

在线体验地址：
<https://mrxn.net/botcheck/index.html>
...
文章标题：
[Googlebot | Bingbot IP 验证工具](https://mrxn.net/jswz/Googlebot-Bingbot-IP-Check-Tools.html)
  
文章链接：
<https://mrxn.net/jswz/Googlebot-Bingbot-IP-Check-Tools.html>
...
text: encodeURI("https://mrxn.net/jswz/Googlebot-Bingbot-IP-Check-Tools.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
