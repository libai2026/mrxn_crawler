...
PKI既不是一个协议，也不是一个软件，它是一个标准，在这个标准之下发展出的为了实现安全基础服务目的的技术统称为PKI。可以说CA(认证中心)是PKI的核心，而数字证书是PKI的最基本元素，还有如apache等服务器、浏览器等客户端、银行等应用，都是pki的组件。这篇文章可以帮助理解：
...
参考
[http://en.wikipedia.org/wiki/X.509](https://en.wikipedia.org/wiki/X.509)
。

另外一个常用的标准是
`PKCS#12`
，通常采用pfx,p12作为文件扩展名，openssl和java的keytool工具都可以用作生产此类格式的证书。
...
[![OpenSSL 与 SSL 数字证书概念贴](https://mrxn.net/content/uploadfile/201509/a2f41443107513.gif "点击查看原图")](https://mrxn.net/content/uploadfile/201509/a2f41443107513.gif)
...
文章标题：
[OpenSSL 与 SSL 数字证书概念贴](https://mrxn.net/jswz/openssl-certificate-encryption.html)
  
文章链接：
<https://mrxn.net/jswz/openssl-certificate-encryption.html>
...
text: encodeURI("https://mrxn.net/jswz/openssl-certificate-encryption.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
