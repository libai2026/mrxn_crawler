...
汉王e脸通综合管理平台 exportResourceByFilePath.do 接口存在任意
[文件读取漏洞](https://mrxn.net/tag/%E6%96%87%E4%BB%B6%E8%AF%BB%E5%8F%96)
。攻击者可在无需认证的情况下，通过构造恶意请求访问 exportResourceByFilePath.do 接口，传入任意文件路径参数，实现服务器上任意文件的读取，影响系统敏感数据的泄露和信息安全。
...
![汉王e脸通综合管理平台 exportResourceByFilePath.do 任意文件读取漏洞](https://image.mrxn.net/2a8433a9dbc84c42b130766151fbf778.webp)
...
文章链接：
<https://mrxn.net/jswz/hanvon-efacego-leaveList-exportResourceByFilePath-fileread.html>
