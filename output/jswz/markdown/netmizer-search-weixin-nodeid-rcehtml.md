...
多个用户可控且无过滤和校验的参数如 nodeid、username、uid 直接拼接进cmd命令中，然后使用popen执行命令，造成
...
![NetMizer日志管理系统 weixin.php 命令执行漏洞](https://image.mrxn.net/d870b4b1ea4e4d16823eb782280d5acc.webp)
...
文章链接：
<https://mrxn.net/jswz/netmizer-search-weixin-nodeid-rce.html>
