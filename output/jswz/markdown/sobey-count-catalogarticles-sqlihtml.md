...
索贝产品中的 /sobey-mchEditor/count/catalogArticles 接口存在
...
参数
**id**
无任何过滤或校验处理，被直接拼接到wzSql这个sql语句中执行，从而造成了
[SQL注入](https://mrxn.net/tag/SQL%E6%B3%A8%E5%85%A5)
漏洞。
...
![索贝融媒体 /sobey-mchEditor/count/catalogArticles SQL注入漏洞](https://image.mrxn.net/bba1e7a1e595438884c940c96baa427c.webp)
...
文章标题：
[索贝融媒体 /sobey-mchEditor/count/catalogArticles SQL注入漏洞](https://mrxn.net/jswz/sobey-count-catalogArticles-sqli.html)
  
文章链接：
<https://mrxn.net/jswz/sobey-count-catalogArticles-sqli.html>
...
text: encodeURI("https://mrxn.net/jswz/sobey-count-catalogArticles-sqli.html"),
width: 100,
height: 100,
colorDark: "#000000",
colorLight: "#ffffff",
