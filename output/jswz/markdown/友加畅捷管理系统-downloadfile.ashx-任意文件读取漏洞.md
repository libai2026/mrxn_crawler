...
文章标题：[友加畅捷管理系统 downloadfile.ashx 任意文件读取漏洞](https://mrxn.net/jswz/youjiasoft-downloadfile-file-read.html)  
文章链接：<https://mrxn.net/jswz/youjiasoft-downloadfile-file-read.html>  
